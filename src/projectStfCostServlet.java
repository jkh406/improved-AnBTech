...
public class projectStfCostServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if("PCO_SML".equals(mode)){	
				com.anbtech.pjt.db.pjtStfCostDAO costDAO = new com.anbtech.pjt.db.pjtStfCostDAO(con);
				...
				//분기하기
				getServletContext().getRequestDispatcher("/pjt/staff/projectStfCost_summary.jsp").forward(request,response);
			}
			//개별 실적비용 보기 : 개별상세보기
				...
				//분기하기
				getServletContext().getRequestDispatcher("/pjt/staff/projectStfCost_view.jsp").forward(request,response);
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			//개별상세 내용 보기 : LIST
				...
				//분기하기
				getServletContext().getRequestDispatcher("/pjt/staff/projectStfCost_detail.jsp?Cpage="+Cpage+"&Tpage="+Tpage).forward(request,response);
			}
			//개별 실적비용 작성 : 준비
			else if("PCO_WV".equals(mode)){	
				com.anbtech.pjt.db.pjtStfCostDAO costDAO = new com.anbtech.pjt.db.pjtStfCostDAO(con);
				com.anbtech.pjt.db.pjtScheduleDAO schDAO = new com.anbtech.pjt.db.pjtScheduleDAO(con);
				...
				man_list = costDAO.getPjtMember(pjt_code);
				...
				//분기하기
				getServletContext().getRequestDispatcher("/pjt/staff/projectStfCost_write.jsp").forward(request,response);
			}
			//개별 실적비용 작성 : 입력하기
			else if("PCO_W".equals(mode)){	
				com.anbtech.pjt.db.pjtStfCostDAO costDAO = new com.anbtech.pjt.db.pjtStfCostDAO(con);
				com.anbtech.pjt.db.pjtScheduleDAO schDAO = new com.anbtech.pjt.db.pjtScheduleDAO(con);
				...
				try{
					//비용 등록하기
					costDAO.inputCost(pjt_code,pjt_name,node_code,node_name,user_id,user_name,cost_type,node_cost,exchange,in_date,remark);
			...
			//개별 실적비용 수정 : 준비
				...
				//분기하기
				getServletContext().getRequestDispatcher("/pjt/staff/projectStfCost_modify.jsp").forward(request,response);
			}
			//개별 실적비용 수정 : 수정하기
			else if("PCO_M".equals(mode)){	
				com.anbtech.pjt.db.pjtStfCostDAO costDAO = new com.anbtech.pjt.db.pjtStfCostDAO(con);
				com.anbtech.pjt.db.pjtScheduleDAO schDAO = new com.anbtech.pjt.db.pjtScheduleDAO(con);
				...
				try{
					//비용 수정하기
					costDAO.updateCost(pid,pjt_code,node_code,node_name,user_id,user_name,cost_type,node_cost,exchange,in_date,remark);
