...
public class mbomItemTable
{
	...
	private String loss_rate;					//부품 LOSS율
	...
	private String trans_date;					//I/F 일자 [MBOM_STR -> MBOM_ITEM]
	...
	//부품 LOSS율
	public void setLossRate(String loss_rate)		{ this.loss_rate = loss_rate;		}
	public String getLossRate()						{ return this.loss_rate;			}
	...
	//I/F 일자 [MBOM_STR -> MBOM_ITEM]
	public void setTransDate(String trans_date)		{ this.trans_date = trans_date;		}
	public String getTransDate()					{ return this.trans_date;			}
