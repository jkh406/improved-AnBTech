...
public class EtcInOutInfoTable {
	private String mid;
	private String in_or_out;
	private String inout_no;
	...
	public String getInOrOut() { return in_or_out; }
	public void setInOrOut(String string) { in_or_out = string; }

	public String getInOutNo() { return inout_no; }
	public void setInOutNo(String string) { inout_no = string; }

	public String getInOutDate() { return inout_date; }
	public void setInOutDate(String string) { inout_date = string; }

	public String getInOutType() { return inout_type; }
	public void setInOutType(String string) { inout_type = string; }

	public String getInOutTypeName() { return inout_type_name; }
	public void setInOutTypeName(String string) { inout_type_name = string; }

	public String getTotalMount() { return total_mount; }
	public void setTotalMount(String string) { total_mount = string; }
	...
	public String getInOutCost() { return inout_cost; }
	public void setInOutCost(String string) { inout_cost = string; }
