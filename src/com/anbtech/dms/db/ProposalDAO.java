...
public class ProposalDAO{
	...
	/*****************************************************************************
	 * 조건에 맞는 proposal_data 테이블 리스트을 가져온다.
	 *****************************************************************************/
	public ArrayList getProposalData_List(String login_id,String tablename,String mode,String searchword,String searchscope,String category,String page) throws Exception {

		Statement stmt = null;
		ResultSet rs = null;

		com.anbtech.dms.entity.ProposalTable table = new com.anbtech.dms.entity.ProposalTable();
...
//		com.anbtech.dms.business.TechDocBO techdocBO = new com.anbtech.dms.business.TechDocBO(con);
		...
		for(int i=0; i < l_maxlist; i++){
			...
			table = new com.anbtech.dms.entity.ProposalTable();
			table.setTid(t_id);
	 ...
	 * version  : 버젼 코드
	 *******************************************************************/
	public ProposalTable getProposalData(String tablename,String data_no,String ver_code) throws Exception{
		...
		table.setGoodsName(rs.getString("goods_name"));
		table.setWhyPropose(rs.getString("why_propose"));
		table.setCountryName(rs.getString("country_name"));
		table.setCompanyName(rs.getString("company_name"));
		table.setCustomerName(rs.getString("customer_name"));
		table.setCustomerTel(rs.getString("customer_tel"));
	...
	public boolean saveData(String tablename,String ver_code,String data_id,String preview,String save_period,String security_level,String written_lang,String doc_type,String save_url,String where_from,String writer,String register,String register_day,String reference,String eco_no,String copy_num,String subject,String doc_no,String category_id,String stat,String hit,String goods_name,String why_propose,String country_name,String company_name,String customer_name,String customer_tel) throws Exception{
		...
		String query = "INSERT INTO proposal_data" + "(ver_code,ancestor,preview,save_period,security_level,written_lang,doc_type,save_url,where_from,writer,register,register_day,reference,eco_no,copy_num,subject,doc_no,category_id,stat,hit,writer_s,register_s,register_day_s,goods_name,why_propose,country_name,company_name,customer_name,customer_tel) VALUES " + "(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		...
		pstmt.setString(24,goods_name);
		pstmt.setString(25,why_propose);
		pstmt.setString(26,country_name);
		pstmt.setString(27,company_name);
		pstmt.setString(28,customer_name);
		pstmt.setString(29,customer_tel);
	...
	public boolean saveData(String tablename,String ver_code,String data_id,String preview,String why_revision,String save_period,String security_level,String written_lang,String doc_type,String save_url,String where_from,String writer,String register,String register_day,String reference,String eco_no,String copy_num,String subject,String doc_no,String category_id,String stat,String hit,String goods_name,String why_propose,String country_name,String company_name,String customer_name,String customer_tel) throws Exception{
		...
		String query = "INSERT INTO proposal_data" + "(ver_code,ancestor,preview,why_revision,save_period,security_level,written_lang,doc_type,save_url,where_from,writer,register,register_day,reference,eco_no,copy_num,subject,doc_no,category_id,stat,hit,writer_s,register_s,register_day_s,goods_name,why_propose,country_name,company_name,customer_name,customer_tel) VALUES " + "(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		...
		pstmt.setString(25,goods_name);
		pstmt.setString(26,why_propose);
		pstmt.setString(27,country_name);
		pstmt.setString(28,company_name);
		pstmt.setString(29,customer_name);
		pstmt.setString(30,customer_tel);
	...
	public void updateData(String tablename,String t_id,String preview,String save_period,String security_level,String written_lang,String doc_type,String save_url,String where_from,String writer,String register,String w_time,String reference,String eco_no,String copy_num,String modify_history,String goods_name,String why_propose,String country_name,String company_name,String customer_name,String customer_tel) throws Exception{
		...
		query = "UPDATE " + tablename + " SET preview=?,save_period=?,security_level=?,written_lang=?,doc_type=?,save_url=?,where_from=?,writer=?,register=?,register_day=?,reference=?,eco_no=?,copy_num=?,modify_history=?,goods_name=?,why_propose=?,country_name=?,company_name=?,customer_name=?,customer_tel=? WHERE t_id='"+t_id+"'";
		pstmt = con.prepareStatement(query);
		...
		pstmt.setString(15,goods_name);
		pstmt.setString(16,why_propose);
		pstmt.setString(17,country_name);
		pstmt.setString(18,company_name);
		pstmt.setString(19,customer_name);
		pstmt.setString(20,customer_tel);
		pstmt.executeUpdate();
		pstmt.close();
	...
	public ArrayList getReference_list(String tablename, String d_id, String version) throws Exception{
		...
		for(int i=0; i<ref_count; i++){ 
			...
			ProposalTable reference = new ProposalTable();
	...
	public ArrayList getVerList(String mode, String tablename, String data_id) throws Exception{
		...
		rs = stmt.executeQuery(query);
		while(rs.next()){ 
			ProposalTable version = new ProposalTable();
