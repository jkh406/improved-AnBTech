...
public class ProposalTable{
	...
	private String goods_name;		//제안제품명
	private String why_propose;		//제안사유
	private String country_name;	//제안국가명
	private String company_name;	//제안회사명
	private String customer_name;	//담당자명
	private String customer_tel;	//담당자전화번호
	...
	public String getWhyPropose(){
		return why_propose;
	}
	public void setWhyPropose(String why_propose){
		this.why_propose = why_propose;
	}
