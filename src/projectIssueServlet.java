...
public class projectIssueServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList para_list = new ArrayList();
			...
			table.setNoteStatus(issue_status);		//issue 상태
		...
		try {
			...
			if("PIS_L".equals(mode)){	
				...
				int Cpage = issueDAO.getCurrentPage();		//현재페이지
				int Tpage = issueDAO.getTotalPage();		//전체페이지
			...
			//이슈관리정보 : 최근에 진행중/승인대기 중인 작업내용 보기 (문제점 등록/수정 공통항목)
