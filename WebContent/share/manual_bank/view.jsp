	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			<TBODY>
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><IMG src="../share/images/blet.gif"> 메뉴얼꾸러미</TD></TR></TBODY></TABLE></TD></TR>
...
<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <!--기본정보-->
		<TABLE cellspacing=0 cellpadding=2 width="100%" border=0>
			...
			<TR><TD width="13%" height="25" class="bg_03" background="../share/images/bg-01.gif">메뉴얼명</td>
				<TD width="37%" height="25" class="bg_04" colspan='3'><%=sbTable.getSubject()%></td></TR>
			<TR bgcolor=c7c7c7><TD height=1 colspan="4"></td></tr>
			<TR><TD width="13%" height="25" class="bg_03" background="../share/images/bg-01.gif">메뉴얼번호</td>
