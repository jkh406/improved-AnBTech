...
<TABLE  cellSpacing=0 cellPadding=0 width="100%">
  <TR></TD>
	<TABLE  cellSpacing=0 cellPadding=0 width="100%">
		...
		<TR>
			<TD height="33" valign="middle" bgcolor="#73AEEF" ><img src="images/cm_itemsearch.gif" hspace="10" alt='품목검색'></TD>
			<TD style="padding-right:10px" align='right' valign='middle'  bgcolor="#73AEEF"></TD></TR>
		<TR><TD height="2" bgcolor="2167B6"  colspan='2'></TD></TR></TBODY></TABLE></TD></TR>
  <TR><TD>
	<TABLE  cellSpacing=0 cellPadding=0 width="100%">	
		<TBODY>
			<TR><TD width="100%%">
				<IFRAME name="search" src="../servlet/CodeMgrServlet?mode=list_item_p" width="100%" height="352" border="0" frameborder="0" scrolling="no">브라우저가 인라인 프레임을 지원하지 않거나 현재 인라인 프레임을 표시하지 않도록 설정되어 있습니다.</IFRAME></TD></TR></TBODY></TABLE></TD></TR>
  <TR><TD>
	<TABLE  cellSpacing=0 cellPadding=0 width="100%">	
		...
		<TR><TD width="820" height=3 bgcolor="0C2C55" colspan='3'></TD></TR></TBODY></TABLE></TD></TR></TABLE>
	<!-- IFRAME에서 받아오는 변수 값 -->
