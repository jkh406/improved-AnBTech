...
<TABLE  cellspacing=0 cellpadding=0 width="100%" border=0>
	<TBODY>
		...
		<tr bgcolor="c7c7c7"><td height="1" colspan="4"></td></tr>
		<tr>
           <td width="13%" height="25" class="bg_03" background="../cm/images/bg-01.gif">첨부파일</td>
...
<!-- 품목상제정보 -->
 <TABLE border=0 width='100%'><TR><TD align=left><IMG src='../cm/images/cm_spec_d.gif' border='0' alt='품목규격'></TD></TR></TABLE>
 <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY><TR bgColor=#9DA9B9 height=1><TD colspan=9></TD></TR>
			<TR vAlign=middle height=23>
			  <TD noWrap width=60 align=middle class='list_title'>코드</TD>
