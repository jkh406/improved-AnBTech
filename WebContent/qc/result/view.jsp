	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../qc/images/blet.gif"> 품목검사결과정보</TD></TR></TBODY>
		</TABLE></TD></TR>
...
<% }	%>
			  <a href="javascript:go_list('<%=link_list%>');"><img src="../qc/images/bt_list.gif" border="0" align="absmiddle" ></a></TD>
			  <TD align=left width=100><%=pre_request_no%></TD></TR></TBODY></TABLE></TD></TR>
...
%>
			<TR onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
			  ...
			  <TD><IMG height=1 width=1></TD>
			  <TD align=middle class='list_bg'><a href="javascript:view_detail('<%=request_no%>','<%=item_code%>','<%=table2.getInspectionCode()%>','<%=sampled_quantity%>')"><IMG src='../qc/images/bt_view_chk_result.gif' border='0' align='absmiddle'></a></td>
			  <TD><IMG height=1 width=1></TD>
