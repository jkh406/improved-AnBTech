...
<HTML><HEAD><TITLE>생산공정 코드정보 <%=caption%></TITLE>
...
<%	if( j.equals("a")){ // 등록 %>
			<img src="../images/pop_add_item.gif" hspace="10" alt="공정 코드정보 등록">
<%	} else if( j.equals("u")){ // 수정 %>				
			<img src="../images/pop_modify_item.gif" hspace="10" alt="공정 코드정보 수정">
<%	}		%>
				</TD></TR>
				<TR><TD height="2" bgcolor="2167B6"></TD></TR></TBODY></TABLE>
	<TR height=161 valign='middle' align='center'><TD>
		<TABLE cellspacing=0 cellpadding=2 width="94%" border=0>
			<TBODY>
				...
				<TR><TD width="30%" height="25" class="bg_03" background="../images/bg-01.gif">공정코드</TD>
					<TD width="70%" height="25" class="bg_04"><INPUT type='text' name='m_code' value='<%=m_code%>' maxlength='2' size='2'  class="text_01" ></TD></TR>
				<TR bgcolor="c7c7c7"><TD height=1 colspan="2"></TD></TR>
			<TR><TD width="30%" height="25" class="bg_03" background="../images/bg-01.gif">공정Description</TD>
				<TD width="70%" height="25" class="bg_04"><INPUT type='text' name='spec' value='<%=spec%>' maxlength='50' size='40'  class="text_01" ></TD></TR>
			<TR bgcolor="c7c7c7"><TD height=1 colspan="2"></TD></TR>
			<TR><TD width="30%" height="25" class="bg_03" background="../images/bg-01.gif">약어</TD>
				<TD width="70%" height="25" class="bg_04"><INPUT type='text' name='tag' value='<%=tag%>'  maxlength='20' size='10' maxlength='10' class="text_01" ></TD></TR>
			<TR bgcolor="c7c7c7"><TD height=1 colspan="2"></TD></TR></TBODY></TABLE><br></TD></TR>
		<!--꼬릿말-->
...
function checkForm()
{
	...
	// Data전송중에 또 다른 버튼(작업)이 눌러지지 못하도록 처리
