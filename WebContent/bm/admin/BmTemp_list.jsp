...
%>
<HTML>
<HEAD><TITLE>TTEMPATE 공정목록</TITLE>
		...
		<TD vAlign=top>
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				<TBODY>
					...
					<TR bgcolor="#BAC2CD">
						<TD valign='middle' class="title"><img src="../images/blet.gif" align="absmiddle"> TEMPLATE  CODE관리</TD>
			...
			<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
				<TBODY>
					<TR vAlign=middle height=22>
						...
						<TD noWrap width=6 class='list_title'><IMG src="../images/list_tep.gif"></TD>
						<TD noWrap width=200 align=middle class='list_title'>공정코드순서</TD>
						<TD noWrap width=6 class='list_title'><IMG src="../images/list_tep.gif"></TD>
