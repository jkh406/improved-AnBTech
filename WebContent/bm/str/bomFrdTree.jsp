...
<TR valign='top'><TD>	
	<TABLE cellSpacing=0 cellPadding=1 width="100%" border=0 valign="top" style='border-right-width:1px;'>
		<TBODY>
			<TR height=25><!-- 타이틀 및 페이지 정보 -->
				<TD vAlign="center" class="bg_05" background='../bm/images/title_bm_bg.gif' style='padding-left:5px;'>정전개 BOM TREE</TD></TR>
