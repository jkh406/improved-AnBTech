...
<TR><TD>
	<TABLE height="100%" cellSpacing=0 cellPadding=1 width="100%" border=0 valign="top">
		<TBODY>
			...
			<TR height=25><TD vAlign=top style="padding-left:5px" bgcolor=''>
...
function goSearch()
{
	...
	document.sForm.mode.value='fi_search_1';
...
function goBranch(gid,model_code,fg_code)
{
	...
	parent.tree.document.sForm.mode.value='fi_list_1';
	...
	parent.reg.document.eForm.mode.value='fi_preimport_1';
