...
<TR valign='top'><TD>	
	...
	<TBODY>
		<TR height=25><!-- 타이틀 및 페이지 정보 -->
			<TD vAlign="center" align='left' class="bg_05"  background='../bm/images/title_bm_bg.gif' style='padding-left:5px;'>정전개 BOM LIST</TD></TR>
		...
		<TR height="23px"><TD vAlign="center" align='left' style='padding-left:5px;'  bgcolor=''>
			...
			<INPUT type='text' name='' value='<%=model_code_empty%>' size='11'  style='font-size:9pt;color="black";' readonly>
			&nbsp;
			<IMG src='../bm/images/sub_fg_code.gif' align='absmiddle' border='0'>
			<INPUT type='text' name='' value='<%=fg_code_empty%>' size='11' readonly></TD></TR>
		<TR><TD height='1' bgcolor='#9DA8BA'></TD></TR>
		<!--리스트-->
		<TR height=100%>
			<TD vAlign=top>
...
if(model_code != 'null') parent.search.document.all['saving'].style.visibility="hidden";	//메뉴버튼 enable
