...
<HTML>
<HEAD><TITLE>미확정 BOM FG코드 검색 LIST</TITLE>
...
<TR><TD>
	...
	<TBODY>
		<TR height='25px'>
			<TD vAlign=center bgcolor='#DBE7FD' class='bg_05' style="padding-left:5px"  BACKGROUND='../bm/images/title_bm_bg.gif'>미확정 BOM</TD></TR>
		<TR bgColor=#9DA9B9 height=1><TD colspan=4></TD></TR>
		<TR height='25'><TD vAlign='top' bgcolor='' style="padding-left:5px" >
		...
		<TD vAlign=top><!--리스트-->
			<DIV id="item_list" style="position:absolute; visibility:visible; width:100%; height:100%; overflow-x:auto; overflow-y:auto;">	
				<TABLE cellSpacing=0 cellPadding=0 width="100%" border='0'>
					<TBODY><TR vAlign=middle height=23>
...
function goSearch()
{
	...
	document.sForm.mode.value='fg_search';
...
function goBranch(gid,model_code,fg_code)
{
	...
	parent.tree.document.sForm.mode.value='pl_list';
	...
	parent.reg.document.eForm.pid.value='';
