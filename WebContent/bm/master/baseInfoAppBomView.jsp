		...
		<TR height=27><!-- 타이틀 및 페이지 정보 -->
			<TD vAlign=top>
				<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
					<TBODY>
						<TD height="33" valign="middle" bgcolor="#73AEEF" colspan='2'><img src="../bm/images/pop_bom_infolist.gif" alt='BOM 정보보기'></TD></TBODY></TABLE></TD></TR>
		<TR><TD height='27' style='padding-left:7px;'>
...
%>
        ...
        <TR><TD height=32 align=right bgcolor="C6DEF8" style="padding-right:10px">
			<a href='javascript:self.close()'><img src='../bm/images/bt_close.gif' border='0' align='absmiddle'></a></TD></TR>
        <TR><TD width="100%" height=1 bgcolor="0C2C55"></TD></TR>
