...
<TABLE cellSpacing=0 cellPadding=0 width=175 border=0 background='images/lm_bg.gif' height='100%' valign='top'>
  <TBODY>
   <TR>
    <TD align='center' height='3' valign='middle' bgcolor='#cccccc'></TD></TR>  
  <TR>
    <TD onmouseover="menu1.src='images/lm_bm_over.gif'" 
    style="CURSOR: hand" onclick="showhide(1);subhideall()" onmouseout="menu1.src='images/lm_bm.gif'">
	<A href="../servlet/BomBaseInfoServlet?mode=info_list" target="view">
	<IMG src="images/lm_bm.gif" border=0 name=menu1 alt='BOM기본정보관리'></A></TD></TR>
  <TR>
    <TD><SPAN id=block1 style="DISPLAY: none; xCURSOR: hand">
      ...
      border=0>
		...
		<TR bgColor=#f3f3f3 height=22>
		  ...
		  <A onclick="selectedtext(1,1);subhideall()" href="../servlet/BomBaseInfoServlet?mode=info_prewrite" target="view">
		  <SPAN id=m1_1>BOM정보등록</SPAN></A></TD></TR>
		<TR>
          <TD background="images/left_hline.gif" height=1></TD></TR>
        <TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG src="images/blank.gif" width=9><IMG src="images/bullet.gif" align=center> 
		  <A onclick="selectedtext(1,2);subhideall()" href="../servlet/BomBaseInfoServlet?mode=info_list" target="view">
		  <SPAN id=m1_2>BOM정보등록현황</SPAN></A></TD></TR>
        <TR>
          <TD background="images/left_hline.gif" height=1></TD></TR>
		...
		<TR bgColor=#f3f3f3 height=22>
		  ...
		  <SPAN id=m1_3>임시BOM등록현황</SPAN></A></TD></TR>
	...
	<IMG src="images/lm_bm2.gif" border=0 name=menu2 alt='BOM등록관리'></A></TD></TR>
  <TR>
	...
	<IMG src="images/lm_bm3.gif" border=0 name=menu3 alt='BOM구성 조회'></A></TD></TR>
  <TR>
    <TD><SPAN id=block3 style="DISPLAY: none; xCURSOR: hand">
      ...
      border=0>
        ...
        <TR bgColor=#f3f3f3 height=22>
		  ...
		  <SPAN id=m3_1>BOM정전개</SPAN></A></TD></TR>
		<TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG src="images/blank.gif" width=9><IMG src="images/bullet.gif" align=center> 
		  <A onclick="selectedtext(3,2);subhideall()" href="str/bomRevFrame.html" target="view">
		  <SPAN id=m3_2>BOM역전개</SPAN></A></TD></TR>
		<TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG src="images/blank.gif" width=9><IMG src="images/bullet.gif" align=center> 
		  <A onclick="selectedtext(3,3);subhideall()" href="cost/bomCostFrame.html" target="view">
		  <SPAN id=m3_3>BOM원가산출</SPAN></A></TD></TR>
        </TBODY></TABLE></SPAN></TD></TR>
...
%>
  <TR><!--관리자 관리메뉴 -->
    ...
    onmouseout="menu4.src='images/lm_mgr.gif'"><IMG src="images/lm_mgr.gif" border=0 name=menu4></TD></TR>
  <TR>
      ...
      border=0>
        ...
        <TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
            ...
            href="admin/BmBase_list.jsp" target=view><SPAN id=m4_1>생산공정코드관리</SPAN></A> </TD></TR>
        <TR>
          <TD background=images/left_hline.gif height=1></TD></TR>
		<TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
            ...
            href="admin/BmTemp_list.jsp" target=view><SPAN id=m4_2>공정템플릿코드관리</SPAN></A> </TD></TR>
		<TR>
          <TD background=images/left_hline.gif height=1></TD></TR>
	<!--	<TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
		...
		<TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
            src="images/blank.gif" width=9><IMG src="images/bullet.gif" 
            align=center> <A onclick=selectedtext(4,3);subhideall() 
            href="admin/BmGroupMgr.jsp" target=view><SPAN id=m4_3>BOM Group사용자관리 </SPAN></A></TD></TR>
		<TR>
          <TD background=images/left_hline.gif height=1></TD></TR>
		<TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
            ...
            href="admin/BmProcessMgr.jsp" target=view><SPAN id=m4_4>BOM 관리자설정 </SPAN></A></TD></TR>
		</TBODY></TABLE></SPAN></TD></TR>
<%	}else{	%>
