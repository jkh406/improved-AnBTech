...
<BODY background="" marginwidth="0" topmargin="0" leftmargin="0"  oncontextmenu="return false">
	<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
		<TR><TD align="center">
			...
			<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
		        ...
		        <TR><TD height="33" valign="middle" bgcolor="#73AEEF"><img src="../bm/images/pop_sel_mgr.gif"  alt='BOM 관리자 설정' border='0'></TD></TR>
	...
	<TABLE cellspacing=0 cellpadding=0 width="94%" border=0>
		...
		<!--<TR bgcolor=#60A3EC><TD height="2" colspan="2"></TD></TR>-->
			...
			<TR><TD width="50%" style="padding-left:5px" background="../bm/images/bg-011.gif">
