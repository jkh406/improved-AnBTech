	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../pu/images/blet.gif"> 발주의뢰품목 리스트</TD></TR></TBODY>
		</TABLE></TD></TR>
		  ...
		  <TABLE cellSpacing=0 cellPadding=0>
			...
			<TR>
			  ...
			  <TD align=left width=500>
					...
					<IMG src='../pu/images/bt_balju.gif' onClick='javascript:order_selected();' style='cursor:hand' align='absmiddle' alt="선택품목발주의뢰">
					<IMG src='../pu/images/bt_balju.gif' onClick='javascript:estimate_selected();' style='cursor:hand' align='absmiddle' alt="선택품목견적의뢰">
...
<TABLE  cellspacing=0 cellpadding=0 width="100%" border=0>
	<TBODY>
		<TR bgcolor="c7c7c7"><TD height=1 colspan="4"></TD></TR>
		 <TR>
           <TD width="13%" height="25" class="bg_03" background="../pu/images/bg-01.gif">요청번호</TD>
	    ...
	    <TR bgcolor="C7C7C7"><TD height="1" colspan="4"></TD></TR>
		<TR>
           <TD width="13%" height="25" class="bg_03" background="../pu/images/bg-01.gif">요청부서명</TD>
           <TD width="37%" height="25" class="bg_04"><input type='text' size='12' name='requester_div_name'></TD>
           <TD width="13%" height="25" class="bg_03" background="../pu/images/bg-01.gif">요청자명</TD>
           <TD width="37%" height="25" class="bg_04"><input type='text' size='12' name='requester_info'></TD></TR>
	    <TR bgcolor="C7C7C7"><TD height="1" colspan="4"></TD></TR>
		<TR>
           <TD width="13%" height="25" class="bg_03" background="../pu/images/bg-01.gif">요청일자</TD>
		...
		<TR>
           ...
           <TD width="37%" height="25" class="bg_04"><input type='text' size='10' name='project_code' value=''> <a href="javascript:sel_model_code();"><img src="../pu/images/bt_search.gif" border="0" align="absmiddle"></a></TD></TR>
	    <TR bgcolor="C7C7C7"><TD height="1" colspan="4"></TD></TR>
<!--
		<TR>
...
<!-- 품목상제정보 -->
 <TABLE border=0 width='100%'>
	<TR><TD width='100%' align='left'><IMG src='../pu/images/request_item.gif' border='0' alt='구매요청품목'></TD></TR>
	<TR><TD align="left" id="table1">
	<DIV id="item_list" style="position:absolute; visibility:visible; width:100%; height:268; overflow-x:scroll; overflow-y:auto;">
	 <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			<TBODY>
				...
				<TR vAlign=middle height=23>
				  ...
				  <TD noWrap width=6 class='list_title'><IMG src="../pu/images/list_tep2.gif"></TD>
				  <TD noWrap width=60 align=middle class='list_title'>요청구분</TD>
				  <TD noWrap width=6 class='list_title'><IMG src="../pu/images/list_tep2.gif"></TD>
				  <TD noWrap width=100 align=middle class='list_title'>요청번호</TD>
				  <TD noWrap width=6 class='list_title'><IMG src="../pu/images/list_tep2.gif"></TD>
...
function estimate_selected() {
	...
	wopen(url,'estimate','800','300','scrollbars=yes,toolbar=no,status=no,resizable=no');
}
...
function view_supply_info(item_code){
	...
	wopen(url,'order','800','200','scrollbars=yes,toolbar=no,status=no,resizable=no');
}
