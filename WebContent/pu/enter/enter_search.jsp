    ...
    <TD vAlign=top>
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../pu/images/blet.gif" align="absmiddle"> 구매입고현황</TD>
		...
		<TABLE height=32 cellSpacing=0 cellPadding=0 width="100%" border='0'>
			<TBODY>
				...
				<TD align=left width='80' style="padding-left:5px">
				   <form method="get" action="../servlet/PurchaseMgrServlet" name="srForm" onSubmit="if(this.searchword.value.length< 2){alert('검색어는 2자이상 입력하셔야 합니다.');this.searchword.value='';this.searchword.focus();return false;}else{checkForm();}" style="margin:0">
					  <select name="searchscope" onChange="selSearchScope();">
						<option value='enter_no'>입고번호</option>
						<option value='enter_date'>입고일자</option>
					  </select>&nbsp;</TD>
				<TD align=left width='500'>
					  ...
					  <div id="enter_date" class="collapsed" style="position:relative;"><table cellSpacing=0 cellPadding=0 width="500" border='0'><tr><td>
	  ...
	  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
			<TR vAlign=middle height=23>
			  ...
			  <TD noWrap width=6 class='list_title'><IMG src="../pu/images/list_tep2.gif"></TD>
			  <TD noWrap width=100 align=middle class='list_title'>매입총액(원)</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../pu/images/list_tep2.gif"></TD>
...
%>
			<TR onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
			  ...
			  <TD><IMG height=1 width=1></TD>
			  <TD align=right class='list_bg' style='padding-right:5px'><%=sp.getMoneyFormat(table.getEnterTotalMount(),"")%></td>
			  <TD><IMG height=1 width=1></TD>
...
function checkForm(){
	...
	if(f.searchscope.value == 'enter_date'){
