	...
	<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      <TBODY>
        <TR><TD height="3" bgcolor="0C2C55" colspan='2'></TD></TR>
			<TR><TD height="33" valign="middle" bgcolor="#73AEEF" ><img src="../images/pop_purchase_type.gif" alt="매입형태찾기"></TD>
				<TD style="padding-right:10px" align='right' valign='middle'  bgcolor="#73AEEF"></TD></TR>
			<TR><TD height='1' bgcolor='#9DA8BA' colspan='2'></TD></TR></TBODY></TABLE><BR>
...
%>
				<TR onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
					 <TD align=middle height="24" class='list_bg'><%=bean.getData("purchase_type")%></TD>
				  <TD><IMG height=1 width=1></TD>
				  <TD align=middle class='list_bg'><%=bean.getData("purchase_name")%></TD>
				  <TD><IMG height=1 width=1></TD>
				  <TD align=middle class='list_bg'><a HREF="javascript:returnValue('<%=field%>','<%=bean.getData("purchase_type")%>','<%=bean.getData("purchase_name")%>')"><IMG src="../images/lt_sel.gif" border='0' align='absmiddle'></a></TD>
				</TR>
