	...
	<tr><td align="center">
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			<TBODY>
				...
				<TR>
					<TD height="33" valign="middle" bgcolor="#73AEEF"><img src="../images/pop_sel_customer.gif" alt="등록업체찾기"></TD></TR>
				<TR>
			...
			<TBODY>
				...
				<TR height=200><!--리스트-->
					<TD vAlign=top>
						...
						<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
							<TBODY><TR><TD height='1' bgcolor='#9CA9BA' colspan=5></TD></TR>
								<TR vAlign=middle height=23>
									<TD noWrap width=200 align=middle class='list_title'>고객사명</TD>
