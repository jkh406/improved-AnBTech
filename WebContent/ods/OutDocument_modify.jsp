	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../ods/images/blet.gif"> 사외공문수정</TD></TR></TBODY>
		</TABLE></TD></TR>
	   ...
	   <tbody>
        <tr>
		 ...
		 <tr>
		   ...
		   <%
				String btag="",mtag="";
				if(module_name.equals("이메일")) btag = "checked";
				else if(module_name.equals("우편")) mtag = "checked";
				
				out.println("<input type='radio' "+btag+" name='module_name' value='이메일'>이메일");	
				out.println("<input type='radio' "+mtag+" name='module_name' value='우편'>우편");	
			%></td>
           <td width="13%" height="25" class="bg_03" background="../ods/images/bg-01.gif">수신자이메일</td>
           <td width="37%" height="25" class="bg_04"><textarea rows="1" name="rec_name" cols='22'  ><%=rec_name%></textarea>&nbsp;콤마로구분 작성</td></tr>
		 <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
		 <tr>
