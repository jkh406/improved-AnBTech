	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../ods/images/blet.gif"> 공지공문작성</TD></TR></TBODY>
		</TABLE></TD></TR>
	   ...
	   <tbody>
        <tr>
		 ...
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04"><input type="checkbox" name="module_name" value='게시판'>게시판	
					<input type="checkbox" name="mail" value='전자우편'>전자우편</td>
