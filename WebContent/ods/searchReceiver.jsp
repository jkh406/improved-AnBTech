	...
	<table cellspacing=0 cellpadding=0 width="94%" border=0>
	   <tbody>
         ...
         <tr>
           ...
           <td width="50%" class="bg_02"><iframe name="list" src="ReceiverList.jsp?target=<%=target%>" width="100%" height="350" border="0" frameborder="0">브라우저가 인라인 프레임을 지원하지 않거나 현재 인라인 프레임을 표시하지 않도록 설정되어 있습니다.</iframe></td></tr>
         <tr bgcolor="C7C7C7"><td height="1" colspan="2"></td></tr>
