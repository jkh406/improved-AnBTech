...
function goPage(a) 
{
	document.sForm.action='../servlet/OfficialDocumentServlet';
...
function write()
{
	document.sForm.action='../ods/OfficialDocument_write.jsp';
	document.sForm.submit();
}
...
function app()
{
	//sParam = "strSrc=OfficialDocument_App.jsp&id=";
	sParam = "../gw/approval/module/OfficialDocument_App.jsp?id=";
	...
	if(rval == "RL") {
		document.sForm.action='../servlet/OfficialDocumentServlet';
		document.sForm.mode.value='OFD_L';
		document.sForm.submit();
	}
	*/
...
{
	//sParam = "strSrc=OfficialDocumentServlet&mode=OFD_V&id="+id;
	
	//var rval = showModalDialog("../ods/DocModalFrm.jsp?"+sParam,"","dialogWidth:720px;dialogHeight:750px;toolbar=0;location=0;directories=0;status=0;menuBar=0;scrollBars=0;resizable=0");

	wopen('OfficialDocumentServlet?mode=OFD_V&id='+id,'view_doc','680','650','scrollbars=yes,toolbar=no,status=no,resizable=no');
}

//개별내용 보기 (결재승인후)
function contentAppview(id,app_id)
{
	//sParam = "strSrc=OfficialDocumentServlet&mode=OFD_A&id="+id+"&doc_id="+app_id;
	
	//var rval = showModalDialog("../ods/DocModalFrm.jsp?"+sParam,"","dialogWidth:720px;dialogHeight:750px;toolbar=0;location=0;directories=0;status=0;menuBar=0;scrollBars=0;resizable=0");

	wopen('OfficialDocumentServlet?mode=OFD_A&id='+id+'&doc_id='+app_id,'view_doc','680','650','scrollbars=yes,toolbar=no,status=no,resizable=no');
}
...
{
	document.sForm.action='../servlet/OfficialDocumentServlet';
	document.sForm.mode.value='OFD_M';
...
function contentDelete(id)
{
	...
	document.dForm.action='../servlet/OfficialDocumentServlet';
	document.dForm.mode.value="OFD_D";
    ...
    <TD vAlign=top>
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../ods/images/blet.gif" align="absmiddle"> 공지공문</TD>
		...
		<TABLE height=32 cellSpacing=0 cellPadding=0 width="100%" border='0'>
			...
			<TR>
			  ...
			  <TD align=left width='400'>
					...
					<%
						String[] sitems = {"subject","receive","user_name","in_date"};
						String[] snames = {"제목","수신","작성자","작성일"};
						String sel = "";
					...
					<input type="hidden" name="mode" size="15" value="OFD_L">
  ...
  <TR height=100%>
	  ...
	  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
			<TR vAlign=middle height=25>
			  ...
			  <TD noWrap width=6 class='list_title'><IMG src="../ods/images/list_tep.gif"></TD>
			  <TD noWrap width=80 align=middle class='list_title'>작성자</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../ods/images/list_tep.gif"></TD>
	...
	%>	
			<TR onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
			  ...
			  <TD><IMG height=1 width=1></TD>
			  <TD align=middle class='list_bg'><%=table.getReceive()%></TD>
			  <TD><IMG height=1 width=1></TD>
			...
			<TR><TD colSpan=13 background="../ods/images/dot_line.gif"></TD></TR>
	<% 
		}  //while 
