  ...
  <tr><td align="center">
	...
	<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      <TBODY>
        ...
        <TR>
          <TD height="33" valign="middle" bgcolor="#73AEEF"><img src="../ods/images/pop_title_mail.gif" width="181" height="17" hspace="10"></TD></TR>
        <TR>
	...
	<table cellspacing=0 cellpadding=2 width="94%" border=0>
       <tbody>
		 ...
		 <tr><td height=25 colspan="4" align="right"><a href="javascript:sendEmail();"><img src="../ods/images/bt_export.gif" border=0></a> <a href="javascript:winClose();"><img src="../ods/images/bt_close.gif" border=0></a></td></tr></tbody></table>
       ...
       <tbody><form name="eForm" method="post" encType="multipart/form-data" style="margin:0">
         ...
         <tr>
           ...
           <td width="87%" height="25"class="bg_04">
			<textarea rows="2" name="rec_mail" cols='70' style="border:1 solid #787878;"><%=rec_mail%></textarea>
