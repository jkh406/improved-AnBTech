	...
	<table cellspacing=0 cellpadding=2 width="94%" border=0>
	   <tbody>
         ...
         <tr>
           ...
           <td width="80%" height="25" class="bg_04"><input type="text" name="s_day" size="9" maxlength="8"> ~ <input type="text" name="e_day" size="9" maxlength="8"> (예)20030623 ~ 20030830</td></tr>
         <tr bgcolor="C7C7C7"><td height="1" colspan="2"></td></tr>
         <tr>
