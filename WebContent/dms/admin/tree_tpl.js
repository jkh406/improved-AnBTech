/*
	...
	page icons collections are welcome, we'll publish them giving all regards.
*/

var img_url = '../dms/admin/icons/';
var tree_tpl = {
    ...
    'icon_32' : img_url + 'base.gif',   // root leaf icon normal
    'icon_36' : img_url + 'base.gif',   // root leaf icon selected
	...
	'icon_24' : img_url + 'folderopen.gif', // node icon opened
