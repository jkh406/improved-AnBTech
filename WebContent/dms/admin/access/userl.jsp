  ...
  <TR height=27><!-- 타이틀 및 페이지 정보 -->
    <TD vAlign=top>
		...
		<TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title">&nbsp;<img src="../../images/blet.gif" align="absmiddle"> 문서엑세스 권한관리</TD>
  ...
  <TR height=32><!--버튼 및 페이징-->
    <TD vAlign=top>
		<TABLE height=32 cellSpacing=0 cellPadding=0 width="100%" border='0'>
			<TBODY>
			<TR>
			  <TD align=left width='500' style='padding-left:5px'><input type="text" name="s" size="10"> <IMG src='../../images/bt_search3.gif' onclick="javascript:document.frml.submit()" align='absmiddle' style='cursor:hand' ></TD></TR></TBODY></TABLE></TD></TR>
...
<%		
		...
		String total_sql = "select a.ac_id,a.au_id,c.ar_name,a.name,a.id,a.office_tel,a.email,a.access_code,b.ac_name from user_table a,class_table b,rank_table c where a.ac_id in ("+classList+") and a.ac_id = b.ac_id and a.rank = c.ar_code and b.isuse='y' order by b.ac_id asc, c.ar_priorty asc";
		bean.executeQuery(total_sql);
	} // if
%>	
	  </td></tr>
	  ...
	  <tr vAlign=middle height=23>
		...
		<td noWrap width=140 align=middle class='list_title'>전화번호</td>
		 <TD noWrap width=6 class='list_title'><IMG src="../../images/list_tep2.gif"></TD>
		<td noWrap width=100% align=middle class='list_title'>문서엑세스권한</td>
		 <TD noWrap width=6 class='list_title'><IMG src="../../images/list_tep2.gif"></TD>
...
%>
	  <tr onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor="#ffffff">
			...
			<TD><IMG height=1 width=1></TD>
			<td height='24' class='list_bg' align=center><%=bean.getData("access_code")%></td>
			<TD><IMG height=1 width=1></TD>
