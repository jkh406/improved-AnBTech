...
<%
java.io.ByteArrayOutputStream osbyte = new java.io.ByteArrayOutputStream();
java.io.PrintStream ps = new java.io.PrintStream(osbyte);
exception.printStackTrace(ps);

String stack = osbyte.toString();
if(ps!=null) ps.close();
if(osbyte!=null) osbyte.close();
%>
                  ...
                  <TABLE cellSpacing=5 cellPadding=0 width=526 border=0>
                    ...
                    <TR>
                      <TD width=400 height=16>죄송합니다. 예상치 못한 에러가 발생했습니다.<br>다시 시도해 보시고, 동일한 문제가 계속 발생시 시스템 관리자에게 문의해 주십시오.<br><br>대리 박동렬 ☎ 031)632-5330,5331 <A 
                        href="mailto:subaksi@anbtech.co.kr?cc=yukjm64@anbtech.co.kr&bcc=jsc21@anbtech.co.kr&subject=Error Report 메일&body=<%=exception.toString()%>">subaksi@anbtech.co.kr</A></TD></TR>
                    <TR>
                      <TD width=400 height=16>&nbsp;</TD></TR>
					<TR>
                      <TD width=400 height=16>에러메시지:<%=exception.toString()%></TD></TR>
                    <TR>
                      <TD width=400 height=16>상세메시지:<br><textarea rows="5" cols="55"><%=stack%></textarea></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR>
        <TR>
          <TD>&nbsp;</TD></TR>
        <TR>
          <TD>&nbsp;</TD></TR>
