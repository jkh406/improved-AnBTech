...
%>
		<script language='javascript'>
			window.open("multi_result_view.jsp?target=UserTreeForSingle.jsp&sWord=<%=sWord%>&sDiv=<%=sDiv%>",'search','width=400,height=100,scrollbars=yes,toolbar=no,status=no,resizable=no');
		</script>
<%
		}
	}
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width=100% border=0>
  ...
  <TR>
    <TD style="PADDING-LEFT: 15px; PADDING-TOP: 10px" vAlign=top>
		<script language="JavaScript" src="user_tree_items_select.js"></script>
		<script language="JavaScript" src="user_tree_single.js"></script>
