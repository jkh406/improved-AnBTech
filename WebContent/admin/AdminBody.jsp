...
src="AdminTitle.htm" frameBorder=NO scrolling=no><FRAME name=Left 
marginWidth=0 marginHeight=0 src="AdminLeft.jsp" frameBorder=0 
noResize></FRAMESET><FRAME name=up marginWidth=0 marginHeight=0 
src="user/userl.jsp" frameBorder=0 noResize 
