...
var tree_tpl = {
	...
	'icon_20' : 'icons/folderopen.jpg', // node icon selected
	'icon_24' : 'icons/folderopen.jpg', // node icon opened
	'icon_28' : 'icons/folderopen.jpg', // node icon selected opened

	'icon_0'  : 'icons/user.jpg', // leaf icon normal
	'icon_4'  : 'icons/user.jpg', // leaf icon selected
