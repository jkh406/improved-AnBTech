...
<%	
	 ...
	 *		
	 *      이 페이지를 호출할 때에는 
	 *		searchSystemMinorCode.jsp?sf=폼이름&div=구분대상&type=특정구분코드&type_name=구분명&code=코드필드&code_name=코드명필드
	 *		식으로 호출한다.
	 * 
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0 valign="top">
	...
	<TR height=27><!-- 타이틀 및 페이지 정보 -->
		...
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			<TBODY>
				...
				<TR><TD height="33" valign="middle" bgcolor="#73AEEF" ><img src="../../images/pop_system_code.gif" alt='System 식별코드'></TD>
	...
	<TR height=27><!--버튼 및 페이징-->
		<TD vAlign=top>
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="98%" border='0' align='center'>
			<TBODY>
				<TR><TD width=4>&nbsp;</TD>
