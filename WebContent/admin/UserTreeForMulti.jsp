...
%>
		<script language='javascript'>
			window.open("multi_result_view.jsp?target=UserTreeForMulti.jsp&sWord=<%=sWord%>&sDiv=<%=sDiv%>",'search','width=400,height=100,scrollbars=yes,toolbar=no,status=no,resizable=no');
		</script>
<%
		}
	}
...
<TABLE height="100%" cellSpacing=10 cellPadding=0 width=100% border=0>
  ...
  <TR>
    <TD valign='top'>
		...
		<script language="JavaScript" src="user_tree_multi.js"></script>
