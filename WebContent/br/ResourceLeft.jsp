...
--><SPAN id=block2 style="DISPLAY: none; xCURSOR: hand"></SPAN>
	...
	<!-- 업무공유 -->
	<TR><!--관리자 설정 -->
    <TD onmouseover="menu3.src='images/lm_share_over.gif'" alt="업무공유"
    style="CURSOR: hand" onclick=showhide(3);subhideall();selectedtext(3,1) 
    onmouseout="menu3.src='images/lm_share.gif'" alt='업무공유'><IMG src="images/lm_share.gif"  alt="업무공유" border=0 
      name=menu3></TD></TR>
	<TR><TD><SPAN id=block3 style="DISPLAY: none; xCURSOR: hand">
        ...
        <TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
			...
			target=up><SPAN id=m3_1>사규나들이</SPAN></A> </TD></TR>
		<TR><TD background=images/left_hline.gif height=1></TD></TR>
        <TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
            src="images/blank.gif" width=9><IMG src="images/bullet.gif" 
            align=center> <A onclick=selectedtext(3,2);subhideall() 
            href="../servlet/ShareBdServlet?tablename=form_bank" target=up><SPAN id=m3_2>양식꾸러미</SPAN></A></TD></TR>
		<TR><TD background=images/left_hline.gif height=1></TD></TR>
		<TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
            src="images/blank.gif" width=9><IMG src="images/bullet.gif" 
			...
			target=up><SPAN id=m3_3>메뉴얼꾸러미</SPAN></A></TD></TR></TBODY></TABLE></SPAN></TD></TR>
...
%>
  <TR><!--예약업무처리 -->
    <TD onmouseover="menu4.src='images/lm_br3_over.gif'" 
    style="CURSOR: hand" onclick=showhide(4);subhideall();selectedtext(4,1) 
    onmouseout="menu4.src='images/lm_br3.gif'"><A 
      ...
      border=0>
        ...
        <TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
            ...
            href="../servlet/BookResourceServlet?category=car&mode=req_list&tablename=charyang_master" target=up><SPAN id=m4_1>공용차량예약신청현황</SPAN></A> </TD></TR></TBODY></TABLE></SPAN></TD></TR>
<%	
	}else{	%>
      ...
      border=0>
        ...
        <TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
            ...
            href="../servlet/BookResourceServlet?category=car&mode=list" target=up><SPAN id=m5_1>공용차량등록관리</SPAN></A> </TD></TR>
		<TR><TD background=images/left_hline.gif height=1></TD></TR>
        <TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
            src="images/blank.gif" width=9><IMG src="images/bullet.gif" 
            align=center> <A onclick=selectedtext(5,3);subhideall() 
            href="../share/admin/settingPrivilege.jsp" target=up><SPAN id=m5_3>업무공유관리자설정</SPAN></A> </TD></TR>
		<TR><TD background=images/left_hline.gif height=1></TD></TR>
        <TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
            src="images/blank.gif" width=9><IMG src="images/bullet.gif" 
            align=center> <A onclick=selectedtext(5,2);subhideall() 
            href="../br/admin/settingPrivilege.jsp" target=up><SPAN id=m5_2>자원예약관리자설정</SPAN></A></TD></TR>			
