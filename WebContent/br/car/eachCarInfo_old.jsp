		...
		<TABLE height=32 cellSpacing=0 cellPadding=0 width="100%" border='0'>
			...
			<TR>
			  ...
			  <TD align=left width='400'><form method="get" name="menuForm" style="margin:0">
					...
					<a href="javascript:lending_App();"><img src="../br/images/bt_reg_car.gif" border="0" align="absmiddle"></a> <a href="javascript:location.href('../servlet/BookResourceServlet?category=car&mode=view_stat');"><img src="../br/images/bt_confirm.gif" border="0" align="absmiddle"></a>
				<%	if(!year.equals("")){	%>
			  ...
			  <TD align=middle class='list_bg'>
					...
					<% }else if(idx < 0 && login_id.equals(write_id) && v_status.equals("예약중")) { %>
							<a href="javascript:lending_cancel(<%=c_id%>,<%=cr_id%>)">
								<img src="../br/images/lt_br_cancel.gif" border='0' align='absmiddle' alt='예약취소'></a>
