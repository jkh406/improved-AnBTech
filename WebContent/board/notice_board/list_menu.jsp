			...
			<TR>
			  ...
			  <TD align=left width='500'><form method=get action='AnBBoard' name=srForm onSubmit="if(this.searchword.value.length< 2){alert('검색어는 2자이상 입력하셔야 합니다.');this.searchword.value='';this.searchword.focus();return false;}else{return true;}" style="margin:0">
				<%=input_hidden_search%>
					  ...
					  </select> <input type=text name=searchword value='' size=15 maxlength=20> <input border=0 onfocus=blur() src="../board/images/bt_search3.gif" border="0" align="absmiddle" type="image">  <a href="<%=link_write%>"><img src="../board/images/bt_reg_notice.gif" border="0" align="absmiddle"></a>
