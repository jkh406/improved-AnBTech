...
function view_doc(strSrc,no) {
	...
	if(strSrc.indexOf("OutDocumentRecServlet") >= 0) wopen('../servlet/'+strSrc+'&no='+no,'view','510','322','scrollbars=yes,toolbar=no,status=no,resizable=no');

	if(strSrc.indexOf("OfficialDocumentServlet") >= 0) wopen('../servlet/'+strSrc+'&no='+no,'view','680','650','scrollbars=yes,toolbar=no,status=no,resizable=no');
}
