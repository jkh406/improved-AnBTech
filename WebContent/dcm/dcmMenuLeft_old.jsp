...
<TABLE cellSpacing=0 cellPadding=0 width=175 border=0 background='images/lm_bg.gif' height='100%' valign='top'>
  ...
  <TR>
	...
	<IMG src="images/lm_bm1.gif" border=0 name=menu1 alt='신규작성'></A></TD></TR>
  <TR>
    <TD><SPAN id=block1 style="DISPLAY: none; xCURSOR: hand">
      ...
      border=0>
        ...
        <TR bgColor=#f3f3f3 height=22>
		  ...
		  <SPAN id=m1_1>사용자발의:ECR</SPAN></A></TD></TR>
        <TR>
		...
		<TR bgColor=#f3f3f3 height=22>
		  ...
		  <SPAN id=m1_2>설계자발의:ECO</SPAN></A></TD></TR>
  ...
  <TR>
	...
	<IMG src="images/lm_bm2.gif" border=0 name=menu2 alt='개인함관리'></A></TD></TR>
  <TR>
  ...
  <TR>
	...
	<IMG src="images/lm_bm3.gif" border=0 name=menu3 alt='부서함관리'></A></TD></TR>
  <TR>
  ...
  <TR>
	...
	<IMG src="images/lm_bm5.gif" border=0 name=menu5 alt='ECO 검색'></A></TD></TR>
  <TR>
  <TR><!--바로가기 -->
