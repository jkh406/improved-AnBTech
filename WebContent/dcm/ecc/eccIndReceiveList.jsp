	...
	<TR height=27>
		<TD vAlign=top><!-- 타이틀 및 페이지 정보 -->
			...
			<TBODY>
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../bm/images/blet.gif" align="absmiddle"> ECR/ECO 수신함</TD>
...
<INPUT type="hidden" name="v_list" size="15" value="ecc_irlist">
</FORM>
</BODY>
</HTML>
...
function goSearch()
{
	...
	document.sForm.mode.value='ecc_irlist';
...
{
	document.sForm.action='../servlet/CbomProcessServlet';
	document.sForm.mode.value='ecc_mview';
