...
function goSearch()
{
	...
	document.sForm.mode.value='ecc_srlist';
...
<BODY bgColor=#ffffff leftMargin=0 topMargin=0 marginheight="0" marginwidth="0" contextmenu='return false'>
			...
			<TD vAlign=top><!-- 타이틀 및 페이지 정보 -->
				<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
					<TBODY>
						...
						<TR bgcolor="#BAC2CD">
							<TD valign='middle' class="title"><img src="../dcm/images/blet.gif" align="absmiddle"> ECR/ECO 수신함</TD>
		...
		<TR height=32>
			<TD vAlign=top>
				<TABLE height=32 cellSpacing=0 cellPadding=0 width="100%" border='0'>
					<TBODY>
						<TR><TD align=left width='80%' style="padding-left:10px">
		...
		<TR height=100%>
			<TD vAlign=top><!--리스트-->
				<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
					<TBODY>
						<TR bgColor=#9DA9B9 height=2><TD colspan=10></TD></TR>
...
%>
					...
					<TR><TD colspan=10 background="../dcm/images/dot_line.gif"></TD></TR>
<%		
	}
%>
				</TBODY></TABLE></TD></TR>
...
<INPUT type="hidden" name="v_list" size="15" value="ecc_drlist">
</FORM>
</BODY>
</HTML>
