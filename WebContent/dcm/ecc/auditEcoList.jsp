...
{
	document.sForm.action='../servlet/CbomProcessServlet';
	document.sForm.mode.value='audit_view';
		...
		<TR height=27>
			<TD vAlign=top><!-- 타이틀 및 페이지 정보 -->
				...
				<TBODY>
					...
					<TR bgcolor="#BAC2CD">
						<TD valign='middle' class="title"><img src="../bm/images/blet.gif" align="absmiddle"> ECO 적용대상</TD>
...
<INPUT type="hidden" name="v_list" size="15" value="audit_list">
</FORM>
</BODY>
</HTML>
