...
<FORM name="sForm" method="post" style="margin:0" encType="multipart/form-data" onSubmit='goSearch();' >
	...
	<TR height=27>
		<TD vAlign=top><!-- 타이틀 및 페이지 정보 -->
			...
			<TBODY>
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../bm/images/blet.gif" align="absmiddle"> ECR/ECO 작성함</TD>
		...
		<TD vAlign=top>
			...
			<TBODY>
				...
				<TD align=left width='80%' style="padding-left:10px">
					...
					<INPUT type='image' onfocus=blur() src="../dcm/images/bt_search3.gif" border="0" align="absmiddle">
					<a href='javascript:app()'><img src="../dcm/images/bt_sangsin.gif" border='0' align='absmiddle'></a>
					</TD>
			...
			<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
				<TBODY>
					...
					<TR vAlign=middle height=23>
						<TD noWrap width=30 align=middle class='list_title'>구분</TD>
						<TD noWrap width=6 class='list_title'><IMG src="../bm/images/list_tep2.gif"></TD>
						<TD noWrap width=110 align=middle class='list_title'>설계변경번호</TD>
...
%>
					<TR onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
						<TD align=middle height="24" class='list_bg'>
							<INPUT type='checkbox' name='checkbox' value='<%=table.getPid()%>'></TD>
...
function goSearch()
{
	...
	document.sForm.mode.value='ecc_iwlist';
...
function app()
{
	sParam = "../gw/approval/module/cbom_eccApp.jsp?pid=";
