	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../mr/images/blet.gif"> A/S실적등록</TD></TR></TBODY>
		</TABLE></TD></TR>
	...
	<table cellspacing=0 cellpadding=2 width="100%" border=0>
	   <tbody>
		 ...
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04">
				<input type="radio" checked name="as_type" value='1'>방문지원	
				<input type="radio" name="as_type" value='2'>유선지원 </td>
		   <td width="13%" height="25" class="bg_03" background="../mr/images/bg-01.gif">처리여부</td>
           <td width="37%" height="25" class="bg_04">
				<input type="radio" checked name="as_result" value='1'>완료	
				<input type="radio" name="as_result" value='2'>미처리 </td></tr>
		 <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
		 <tr>
           <td width="13%" height="25" class="bg_03" background="../mr/images/bg-01.gif">장비일련번호</td>
           <td width="37%" height="25" class="bg_04">
				<input type='text' name='serial_no' value=''> [S/W는 제외]</td>
...
<input type="hidden" name="worker" value="">			<!-- 수정부위 -->
<input type="hidden" name="company_no" value="C02">		<!-- 수정부위 -->
