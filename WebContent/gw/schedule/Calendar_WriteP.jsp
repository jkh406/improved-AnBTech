...
stop : {
	...
	*********************************************************************/
	...
	String wdn = "";
	while(bean.isAll()) {
		wri = bean.getData("name");			//작성자 이름
		wdn = bean.getData("ac_name");			//작성자 부서
		wName = wri + "/" + id + "/" + wdn;
	}
	...
	*****************************************************/
	...
	//쿼리 문장 (where절)
	item_data = "where (item='CIT')";
	item_data += " or (item='IIT' and id='" + id + "')"; 
	...
	*****************************************************/
	...
	if((Username == null) || (Username.length() == 0)) break stop;
		...
		una=Hanguel.toHanguel(Username.substring(0,First));								//이름
		uid=Hanguel.toHanguel(Username.substring(First+1,Last));						//사번
		udi=Hanguel.toHanguel(Username.substring(Last+1,Username.length()));			//부서명
...
//			mti=etcStartTime + "~" + etcEndTime;										//기타시간 시간
		...
		// 개인일정 저장하기
		//---------------------------------------------------------------
		String DATA = "INSERT INTO CALENDAR_SCHEDULE(pid,id,name,division,isopen,item,sub,mroom,mname,mtel,presents,isselect,myear,mmonth,mday,mtime,content,hday,eyear,emonth,eday,idate)";
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../images/blet.gif"> 개인일정등록</TD></TR></TBODY>
		</TABLE></TD></TR>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr><td align="center"><FORM METHOD=post ACTION="Calendar_WriteP.jsp" NAME="_hdForm1" style="margin:0">
	<!--기본정보-->
	...
	<table cellspacing=0 cellpadding=2 width="100%" border=0>
	   <tbody>
		 ...
		 <tr>
           ...
           <td width="87%" height="25" class="bg_04" colspan="3"><INPUT NAME="hdSubject" VALUE="" size=50 maxlength='50' class='text_01'></td></tr>
		 <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
	...
	<table cellspacing=0 cellpadding=2 width="100%" border=0>
	   <tbody>
		 ...
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04"><INPUT NAME="hdLocation" VALUE="" maxlength='25'  class='text_01'></td>
		 ...
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04"><INPUT NAME="hdChair" VALUE=""  maxlength='10'  class='text_01'></td>
...
<INPUT type="hidden" name="hdFrom" value="openform&amp;view=CalendarView">
<INPUT type="hidden" name="hdIndex" value="0"></form>
</body>
</html>
