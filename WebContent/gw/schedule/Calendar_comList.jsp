...
<%
	...
	*********************************************************************/
	...
	/*********************************************************************
	 	넘겨온 변수 읽기 (from Calendar_WriteC.jsp)   Sabun=&Date=
		사번 : 0
	*********************************************************************/
	...
	***********************************************************************/
	...
	bean.setClear();
	bean.setSearch("id","0","myear",SELyear,"mmonth",SELmonth);
	bean.init_unique();		
%>
...
{  
	...
	location.replace("Calendar_comList.jsp?OpenView&Start=1&count=1000&Sabun=" + cno + "&Date=" + year + "*" + month + "&blank");
    ...
    <TD vAlign=top>
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../images/blet.gif" align="absmiddle"> 회사일정 검색</TD>
  ...
  <TR height=32><!--버튼 및 페이징-->
    <TD vAlign=top><Form Name="goform" onSubmit="return goPage()" style="margin:0">
		<TABLE height=32 cellSpacing=0 cellPadding=0 width="100%" border='0'>
			...
			<TR>
			  <TD width=4>&nbsp;</TD>
			  <TD align=left width='300'><A href="Calendar_comList.jsp?OpenView&Start=1&count=1000&Sabun=<%=cal_id%>&Date=<%=PYear%>*<%=PMonth%>"><img src="../images/arrow_back.gif" border="0"></A> <Script Language="javascript">SelectPage('<%=SELyear%>','<%=SELmonth%>')</Script> <A href="Calendar_comList.jsp?OpenView&Start=1&count=1000&Sabun=<%=cal_id%>&Date=<%=NYear%>*<%=NMonth%>"><img src="../images/arrow_next.gif" border="0"></A></TD></TR></TBODY>
		</TABLE></form></TD></TR>
