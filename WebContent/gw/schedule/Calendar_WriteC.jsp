	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../images/blet.gif"> 회사일정등록</TD></TR></TBODY>
		</TABLE></TD></TR>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr><td align="center"><FORM METHOD=post ACTION="Calendar_WriteC.jsp" NAME="_hdForm1" style="margin:0">
	<!--기본정보-->
...
function ListView()
{	
	var data = "Sabun="+'0'+"&Date="+'<%=toDay%>';	window.open("Calendar_comList.jsp?"+data,"comList","width=500,height=500,scrollbars=yes,toolbar=no,menubar=no,resizable=yes");
}
