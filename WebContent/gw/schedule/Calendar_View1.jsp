...
<%
	...
	***********************************************************************/
	...
	if(Rdate != null) {
		...
		//6일을 더한 년,월(1주의 마지막 날자)
		String ADDM = anbdt.getDate(Ryear,Rmonth,Rday,6);
...
function OpenCalendar(FieldName) {
	var tmp=document.URL.split("/hdForm3?OpenForm")
	var strUrl=tmp[0] + "/calendar?OpenForm&FieldName=" + FieldName
...
<INPUT NAME="hdSabun" VALUE="<%=cal_id%>" type="hidden">
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../images/blet.gif"> 주간일정</TD></TR></TBODY>
		</TABLE></TD></TR>
	...
	<TR><TD height=32><!--버튼-->
		  <TABLE cellSpacing=0 cellPadding=0>
			...
			<TR>
			  ...
			  <TD align=left width=30><a href="Calendar_View1.jsp?Sabun=<%=cal_id%>&Date=<%=cal_td%>" onMouseOver="window.status='주간 일정 보기';return true;" onMouseOut="window.status='';return true;"><img src="../images/view_w_o.gif" border="0"></a></TD>
			  <TD width=7 align='center'><IMG src="../images/11.gif"></TD>
			  <TD align=left width=30><a href="Calendar_View2.jsp?Sabun=<%=cal_id%>&Date=<%=cal_td%>" onMouseOver="window.status='2주간 일정 보기';return true;" onMouseOut="window.status='';return true;"><img src="../images/view_2w.gif" border="0"></TD>
			  <TD width=7 align='center'><IMG src="../images/11.gif"></TD>
	  ...
	  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
			<TR vAlign=middle height=25>
			  <TD width=50% align=middle class='calendar_title'><%=Pd0%> <IMG src="../images/sunday_1.gif" align="absmiddle"></TD>
			  <TD width=50% align=middle class='calendar_title'><%=Pd1%> <IMG src="../images/monday_1.gif" align="absmiddle"></TD>
  ...
  <TR><!--화수-->
    <TD vAlign=top>
	  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
			<TR vAlign=middle height=25>
			  <TD width=50% align=middle class='calendar_title'><%=Pd2%> <IMG src="../images/tuesday_1.gif" align="absmiddle"></TD>
			  <TD width=50% align=middle class='calendar_title'><%=Pd3%> <IMG src="../images/wednesday_1.gif" align="absmiddle"></TD>
		   </TR></TBODY></TABLE></TD></TR>
  <TR><TD height='1' bgcolor='#CCCCCC'></TD></TR>
  <TR>
    <TD vAlign=top>
  ...
  <TR><!--목금-->
    <TD vAlign=top>
	  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
			<TR vAlign=middle height=25>
			  <TD width=50% align=middle class='calendar_title'><%=Pd4%> <IMG src="../images/thursday_1.gif" align="absmiddle"></TD>
			  <TD width=50% align=middle class='calendar_title'><%=Pd5%> <IMG src="../images/friday_1.gif" align="absmiddle"></TD>
		   </TR></TBODY></TABLE></TD></TR>
  <TR><TD height='1' bgcolor='#CCCCCC'></TD></TR>
  <TR>
    <TD vAlign=top>
  ...
  <TR><!--토-->
    <TD vAlign=top>
	  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
			<TR vAlign=middle height=25>
			  <TD width=50% align=middle class='calendar_title'><%=Pd6%> <IMG src="../images/saturday_1.gif" align="absmiddle"></TD>
