	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			<TBODY>
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title">&nbsp;<img src="../../admin/images/blet.gif"> 일정관리자 및 공휴일 관리</TD></TR></TBODY></TABLE></TD></TR></TABLE>
<!-- 회사일정 관리자 -->
<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
	<TR><TD>
		...
		<TABLE cellspacing=0 cellpadding=0 width="100%" border=0>
			...
			<TR><TD align='middle' background="../../admin/images/bg-01.gif" width='80' style='COLOR:#4D91DC;FONT WEIGHT : bolder;font-size: 9pt;'>관리자</TD>
				...
				<TD style='padding-left:5px;' width='150' valign='bottom'><INPUT TYPE=text NAME='csmc_id' SIZE=19><br>
	...
	<TR><TD>
		...
		<TABLE cellspacing=0 cellpadding=0 width="100%" border=0>
			...
			<TR><TD align='middle' background="../../admin/images/bg-01.gif" width='80' style='COLOR:#4D91DC;FONT WEIGHT : bolder;font-size: 9pt;'>관리자</TD>
				...
				<TD style='padding-left:5px;' width='150' valign='bottom'><INPUT TYPE=text NAME='csmd_id' SIZE=19><br><a href="javascript:addItemCsmd();"><img src='../images/bt_add.gif' border='0' align='absmiddle'></a>&nbsp;<a href="javascript:delItemCsmd();"><img src='../images/bt_del_sel.gif' border='0' align='absmiddle'></a>
				</TD>
				<TD align='middle' background="../../admin/images/bg-01.gif" width='80' style='COLOR:#4D91DC;FONT WEIGHT:bolder;font-size:9pt;'>역 할</TD>
				<TD style='padding-left:5px;font-size: 9pt;'><!--<%=description%>--></TD></Tr>
				</TD></TR></TBODY></TABLE><!--내용끝-->	
	...
	<TR><TD>
		...
		<TABLE cellspacing=0 cellpadding=0 width="100%" border=0>
			...
			<TR><TD align='middle' background="../../admin/images/bg-01.gif" width='80' style='COLOR:#4D91DC;FONT WEIGHT : bolder;font-size: 9pt;'>관리자</TD>
				...
				out.println("</select>");
			  %><br>
				<INPUT TYPE=text NAME='hd_text' SIZE=19><br><a href="javascript:addItemHD();"><img src='../images/bt_add.gif' border='0' align='absmiddle'></a><input type="hidden" name="hd_del_req">&nbsp;<a href="javascript:delItemHD();"><img src='../images/bt_del_sel.gif' border='0' align="absmiddle"></a>
				</TD>
				<TD align='middle' background="../../admin/images/bg-01.gif" width='80' style='COLOR:#4D91DC;FONT WEIGHT:bolder;font-size:9pt;'>역 할</TD>
				<TD style='padding-left:5px;font-size: 9pt;'><%=description%></TD></Tr>
				</TD></TR></TBODY></TABLE><!--내용끝-->	
