...
<%
	//페이지당 출력수 설정
	bean.setRowNo(20);					//한페이지당 20개씩 출력
	  ...
	  <TBODY>
		<TR>
		  ...
		  <TD style="PADDING-TOP: 10px">&nbsp;&nbsp;<IMG 
			...
			<%	
				if(PROCESS.equals("REC_ING"))		//받은편지 그림
					out.println("받은 편지함");
				else if(PROCESS.equals("SND_ING"))	//보낸편지 그림
					out.println("보낸 편지함");
				else if(PROCESS.equals("TMP_ING"))	//보낼편지 그림
					out.println("보낼 편지함");
				else if(PROCESS.equals("WST_ING"))	//지운편지 그림
					out.println("지운 편지함");
			%>			
			</FONT></TD>
		  <TD style="PADDING-TOP: 10px" align='right'></TD>
		  <TD width=100 align='left'><%=bean.getCurrentPage()%>/<%=bean.getLastPage()%> 페이지</TD></TR></TBODY></TABLE>
</td></tr>
<tr><td height=28><!--버튼-->
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 valign='top'>
        <TBODY>
			<TR vAlign=center bgColor=#E6F5FF height=22>
			  ...
			  <TD noWrap width=50 align=middle background="../img/list_bg.gif" style="CURSOR: hand" onclick="JavaScript:go_sort('1');">구 분</TD>
			  <TD noWrap width=6 background="../img/list_bg.gif"><IMG src="../img/list_tep.gif"></TD>
			  <TD noWrap width=100% align=middle background="../img/list_bg.gif" style="CURSOR: hand" onclick="JavaScript:go_sort('1');">제목</TD>
			  <TD noWrap width=6 background="../img/list_bg.gif"><IMG src="../img/list_tep.gif"></TD>
			  <TD noWrap width=100 align=middle background="../img/list_bg.gif" style="CURSOR: hand" onclick="JavaScript:go_sort('1');">발신자</TD>
			  <TD noWrap width=6 background="../img/list_bg.gif"><IMG src="../img/list_tep.gif"></TD>
			  <TD noWrap width=150 align=middle background="../img/list_bg.gif" style="CURSOR: hand" onclick="JavaScript:go_sort('1');">발신일</TD>
		   </TR>

<% if (bean.isEmpty()) { %>
			<tr><td colspan='9'><center>***** <%=PROCESS_NAME%>함이 비어 있습니다. *****</center></td></tr> 
<% } %>	
