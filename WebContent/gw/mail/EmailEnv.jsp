	...
	<table cellspacing=0 cellpadding=2 width="94%" border=0>
	   <tbody>
		 ...
		 <tr>
           ...
           <td width="80%" height="25" class="bg_02"><input name="readtype" type="checkbox" <% if(readtype.equals("RO")) out.println("CHECKED"); %> value="<%=readtype%>" size="20" >서버에 메시지 복사본 저장<br>체크 시 메시지를 가져와도 서버에 원본을 유지합니다.</td></tr>
         <tr bgcolor="C7C7C7"><td height="1" colspan="2"></td></tr>
		 <tr>
           <td width="20%" height="25" class="bg_01" background="../images/bg-01.gif">이름</td>
           <td width="80%" height="25" class="bg_02">
		   <%
			if(username.length() == 0) out.println("<input name='username' value='" + name + "' type='text' size='10'>");
			else out.println("<input name='username' value='" + username + "' type='text' size='10'>");
		 ...
		 <tr>
           ...
           <td width="80%" height="25" class="bg_02">
		   <%
			if(useraddress.length() == 0) out.println("<input name='useraddress' value='" + email + "'  type='text' size='30'>");
