...
//  var tmp = eval("self.opener.document.forms[0]." + document.forms[0].s_day.value);

	var tmp = opener.document.frm1.<%=where%>;
...
//	  var toField = opener.document.frm1.s_day;
//    toField.value = year + "/" + month + "/" + day;
	  opener.document.frm1.<%=where%>.value = year + "/" + month + "/" + day;
      window.close();
    }
}    
