...
{ 
        var sampleWidth = 450;                        // 윈도우의 가로 사이즈 지정 
        var sampleHeight = 300;                       // 윈도으이 세로 사이즈 지정 
...
<% if(Message == "PASS") { %>
<script>
window.open('post_view.jsp?PID=<%=pid%>&Title=<%=TITLE%>','post_decision','width=780,height=500,scrollbars=yes,toolbar=no');
</script>
<% Message = "" ; } %>
