	...
	<table cellspacing=0 cellpadding=2 width="100%" border=0>
	   <tbody>
		 ...
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04"><input size=20 type="text" name="destination" class='text_01'></td>
           <td width="13%" height="25" class="bg_03" background="../../images/bg-01.gif">출장목적</td>
           <td width="37%" height="25" class="bg_04"><input size=30 type="text" name="purpose" class='text_01'></td></tr>
         <tr bgcolor=c7c7c7><td height=1 colspan="4"></td></tr>
		 <tr>
...
function eleApprovalRequest()
{
	...
	document.eForm.mode.value='CHULJANG_BOGO';	
...
function eleApprovalTemp()
{
	...
	document.onmousedown=dbclick;
	document.eForm.action="../../../servlet/BogoSeoServlet";
	document.eForm.mode.value='CHULJANG_BOGO_TMP';
