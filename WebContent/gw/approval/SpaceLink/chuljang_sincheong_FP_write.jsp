...
<%
	...
	*********************************************************************/	
	...
	String prj_code = multi.getParameter("prj_code"); 
		if(prj_code == null) prj_code = "";											//프로젝트 코드
...
<form action="chuljanb_sincheong_FP_write.jsp" name="eForm" method="post" encType="multipart/form-data" style="margin:0">
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../../images/blet.gif"> 출장신청서 작성</TD>
			  </TR></TBODY>
		</TABLE></TD></TR>
	...
	<table cellspacing=0 cellpadding=2 width="100%" border=0>
	   <tbody>
		 ...
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04">
				<input type='text' name='gab_days' value='0박 1일간' class="text_01" readonly></td>
		 ...
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04"><input size="15" type="text" name="project_code" value='<%=prj_code%>' readonly> <input size="10" type="text" name="prj_name" value='' readonly> <a href="javascript:sel_pjt_code();"><img src="../../images/bt_search.gif" border="0" align="absmiddle"></a></td>
	...
	<table cellspacing=0 cellpadding=2 width="100%" border=0>
	   <tbody>
           ...
           <td width="87%" class="bg_04" colspan="3" valign='top'>
			<%
				...
				for(int n=1,p=0; p < cnt; n++,p++) {
					...
					out.print("<td class=bg_07><input class='money' size=15 type='text' name='cost"+n+"' value='0' style='text-align:right;' onKeyPress='isNumObj(this);' onKeyUp='InputMoney(this);'></td>");//청구금액(금액)
					out.print("<td class=bg_07><input class='money' size=15 type='text' name='ep_cost"+n+"' value='0' style='text-align:right;' onKeyPress='isNumObj(this);' onKeyUp='InputMoney(this);' readonly></td>");//지급금액(금액)
					out.print("<td class=bg_07><input size=40 type='text' name='cont"+n+"' value=''></td></tr>");
				}
				out.print("<tr><td class=bg_07 align='center'><b>합계</b></td><td class=bg_07><input class='money' size=15 type='text' name='sum' value='0' readonly></td>");
				out.print("<td class=bg_07><input class='money' size=15 type='text' name='ep_sum' value='0' readonly></td></tr>");
				out.print("</table>");
			%>
		   </td></tr>
		 <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04"><input size=30 type="text" name="bank_no" value=''></td>	  
		 </tr>
         <tr bgcolor=c7c7c7><td height=1 colspan="4"></td></tr>
         <tr><td height=10 colspan="4"></td></tr></tbody></table>  
</td></tr></table>
...
function searchProxy()
{
	...
	wopen(url,"proxy","510","467","scrollbars=auto,toolbar=no,status=no,resizable=no");
...
{
	wopen("searchUser.jsp?target=eForm.receiver_id/eForm.receiver_name","proxy","250","380","scrollbars=auto,toolbar=no,status=no,resizable=no");
...
function eleApprovalRequest()
{
	...
	else if(eForm.bistrip_city.value == "") { alert("출장지 도시명을 입력하십시오."); return; }
	else if(eForm.purpose.value == "") { alert("출장목적을 입력하십시오."); return; }

	if(eForm.bistrip_kind.value =="국외") {
		if (eForm.bistrip_country.value =="") { alert("출장지 국가명을 입력하십시오."); return; }
	} else if(eForm.bistrip_kind.value =="국내"){
		if (eForm.doc_tel.value =="") { alert("긴급연락처를 입력하십시오."); return; }
	}
	...
	document.eForm.mode.value='CHULJANG_SINCHEONG';	
...
function eleApprovalTemp()
{
	...
	document.eForm.action="../../../servlet/GeunTaeServlet";
	document.eForm.mode.value='CHULJANG_SINCHEONG_TMP';
