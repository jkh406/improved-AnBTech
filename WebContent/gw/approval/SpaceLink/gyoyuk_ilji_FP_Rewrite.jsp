...
//	String antiprt_prs3= multi.getParameter("antiprt_prs3"); if(antiprt_prs3 == null) antiprt_prs3 = "";
	...
	String read_student = multi.getParameter("read_student");			//피교육생 명단 알리는 정보
	...
	*********************************************************************/
	...
	if(read_student != null) {			//view로 넘겨받을때
...
<form action="gyoyuk_ilji_FP_Rewrite.jsp" name="eForm" method="post" encType="multipart/form-data" style="margin:0">
	...
	<table cellspacing=0 cellpadding=2 width="100%" border=0>
	   <tbody>
		 ...
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04" class='text_01' ><input type="text" size=28 name="edu_subject" value='<%=edu_subject%>'></td>
		 ...
		 <tr>
           ...
           <td width="87%" height="25" colspan="3" class="bg_04"><TEXTAREA NAME="content" rows=3 cols=60  class='text_01' ><%=content%></TEXTAREA></td></tr>
		 <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
		 <tr>
						...
						<td width="100" height="210" align="center" class=bg_07>
								...
								/*for(int i=0; i<people_line; i++) {
									if(participators[i][0].length() != 0)
										out.println("<img src='../../approval/sign/"+participators[i][0]+".gif' width=90 height=20 align='center'>");
								}*/
								%>
						</td>
						<td width="100" height="210" align="center" class=bg_07>
...
<input type='hidden' name='doc_sub' value='[교육일지]'>
...
function eleApprovalRequest()
{
	...
	document.eForm.mode.value='R_GYOYUK_ILJI';	
...
function eleApprovalTemp()
{
	...
	document.eForm.action="../../../servlet/GyoYukServlet";
	document.eForm.mode.value='R_GYOYUK_ILJI_TMP';
