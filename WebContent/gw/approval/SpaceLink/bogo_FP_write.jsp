...
<form action="bogo_FP_write.jsp" name="eForm" method="post" encType="multipart/form-data" style="margin:0">
	...
	<table cellspacing=0 cellpadding=2 width="100%" border=0>
	   <tbody>
		 ...
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04"><input size=30 type="text" name="prj_name"><a href="Javascript:searchProject();"><img src="../../images/bt_search.gif" border="0" align="absmiddle"></a></td>
           <td width="13%" height="25" class="bg_03" background="../../images/bg-01.gif">발주처</td>
           <td width="37%" height="25" class="bg_04"><input size=15 type="text" name="ap_name"></td></tr>
         <tr bgcolor=c7c7c7><td height=1 colspan="4"></td></tr>
		 <tr>
		 ...
		 <tr>
           ...
           <td width="87%" height="25" colspan="3" class="bg_04" style='font-size:8pt;' align='top'>
			   <TABLE><TBODY>
					<TR><TD>
					...
					<TR><TD>
						<textarea name="content" cols="88" rows="10" class='text_01' style='border-width:1; border-style:ridge; border-color:#999999;  font-size = 9pt'></textarea></TD></TR>
			   </TBODY></TABLE>			
		  </td></tr>
		 <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
		 <tr>
...
function eleApprovalRequest()
{
	...
	document.eForm.mode.value='BOGO';	
...
function eleApprovalTemp()
{
	...
	document.onmousedown=dbclick;
	document.eForm.action="../../../servlet/BogoSeoServlet";
	document.eForm.mode.value='BOGO_TMP';
