...
<%
	...
	while(app_iter.hasNext()) {
		...
		if(app.getApStatus().equals("기안")) {
			...
			} else if(PROCESS.equals("APP_BOX") || PROCESS.equals("APP_REP")) {
	...
	// 보고서 정보 알아보기
	*********************************************************************/	
	String[] Column = {"ac_name","user_name","user_rank","in_date","prj_name","ap_name","subject",
	...
	while(bean.isAll()) {
		...
		prj_name = bean.getData("prj_name");		//프로젝트명
		ap_name = bean.getData("ap_name");			//발주처
			  ...
			  <TD align=left width=500>
					...
					//재작성및 View 문서	
						...
						<% if(PROCESS.equals("APP_BOX") && wid.equals(sl.id)) {	//기결함,기안자문서 통보자지정 %> 
							<a href='Javascript:addReceive();'><img src='../../images/bt_addRec.gif' align='absmiddle' border='0' alt='통보자지정'></a>
						<%	} %>
	...
	<table cellspacing=0 cellpadding=2 width="100%" border=0>
	   <tbody>
		 ...
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04"><%=prj_name%></td>
           <td width="13%" height="25" class="bg_03" background="../../images/bg-01.gif">발주처</td>
           <td width="37%" height="25" class="bg_04"><%=ap_name%></td></tr>
         <tr bgcolor=c7c7c7><td height=1 colspan="4"></td></tr>
		 <tr>
