...
<%
	...
	*********************************************************************/	
	...
	bon_file = multi.getParameter("bon_file"); if(bon_file == null) bon_file = "";
	String[][] data = new String[con_cnt][3];
	if(bon_file.length() != 0) {
		//본문파일읽기 (변경내용 배열로 담기)
		String read_con = "";
...
<form action="myeongham_FP_Rewrite.jsp" name="eForm" method="post" encType="multipart/form-data" style="margin:0">
...
<input type='hidden' name='doc_sub' value='[명함신청서]'>
...
function eleApprovalRequest()
{
	...
	document.eForm.mode.value='R_MYEONGHAM';	
...
function eleApprovalTemp()
{
	...
	document.eForm.action="../../../servlet/JiWeonServlet";
	document.eForm.mode.value='R_MYEONGHAM_TMP';
