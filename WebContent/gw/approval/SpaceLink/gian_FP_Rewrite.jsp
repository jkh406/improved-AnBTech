...
<form action="gian_FP_Rewrite.jsp" name="eForm" method="post" encType="multipart/form-data" style="margin:0">
...
<TBODY>
	...
	<TR vAlign=middle height=23>
		<TD noWrap width=40 align=middle class="bg_03" background="../../images/bg-01.gif">메</a>모</TD>
	...
	<table cellspacing=0 cellpadding=2 width="100%" border=0>
	   <tbody>
		 ...
		 <tr>
           ...
           <td width="87%" height="25" colspan="3" class="bg_04"><input size=70 type="text" name="subject" value='<%=subject%>'></td></tr>
		 <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
		 <tr>
           <td width="13%" height="25" class="bg_03" background="../../images/bg-01.gif">내용</td>
           <td width="87%" height="25" colspan="3" class="bg_04"><TEXTAREA NAME="content" rows=36 cols=88><%=content%></TEXTAREA></td></tr>
		 <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
		 <tr>
...
function eleApprovalRequest()
{
	...
	document.eForm.mode.value='R_GIAN';	
...
function eleApprovalTemp()
{
	...
	document.eForm.action="../../../servlet/JiWeonServlet";
	document.eForm.mode.value='R_GIAN_TMP';
