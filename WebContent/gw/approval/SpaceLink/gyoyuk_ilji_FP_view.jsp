...
<%
	...
	*********************************************************************/	
	...
	while(bean.isAll()) {
		...
		antiprt_prs = bean.getData("antiprt_prs");			//불참자 처리		
	...
	<table cellspacing=0 cellpadding=2 width="100%" border=0>
	   <tbody>
		 ...
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04"><%=doc_syear%> 년 <%=doc_smonth%> 월 <%=doc_sdate%> 일</td>
		 ...
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04"><%=participators_cnt%> 명</td></tr>
         <tr bgcolor=c7c7c7><td height=1 colspan="4"></td></tr>
		 <tr>
