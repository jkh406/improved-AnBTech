...
<%
	...
	*********************************************************************/
	...
	for(int n=0; n<work_cnt; n++) for(int m=0; m<2; m++) works[n][m] = "";
...
<center>
<form action="yeonjang_FP_write.jsp" name="eForm" method="post" encType="multipart/form-data">
...
function eleApprovalRequest()
{
	...
	document.eForm.mode.value='YEONJANG';	
...
function eleApprovalTemp()
{
	...
	document.eForm.action="../../../servlet/JanEupServlet";
	document.eForm.mode.value='YEONJANG_TMP';
