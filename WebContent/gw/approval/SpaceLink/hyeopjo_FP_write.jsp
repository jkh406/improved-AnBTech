...
<%
	...
	*********************************************************************/
	...
	String note = multi.getParameter("note"); if(note == null) note = "의 견";		//의견
%>
...
<form action="hyeopjo_FP_write.jsp" name="eForm" method="post" encType="multipart/form-data" style="margin:0">
	...
	<table cellspacing=0 cellpadding=2 width="100%" border=0>
	   <tbody>
		 ...
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04"><textarea rows="1" name="dest_ac_name" cols='20'  class='text_01'></textarea> <a href="Javascript:searchDivision();"><img src="../../images/bt_search.gif" border="0" align="absmiddle"></a></td>
		 ...
		 <tr>
           ...
           <td width="87%" height="25" colspan="3" class="bg_04"><TEXTAREA NAME="content" rows=5 cols=88 class='text_01'></TEXTAREA></td></tr>
		 <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
		 <tr>
           <td width="13%" height="25" class="bg_03" background="../../images/bg-01.gif">관련근거</td>
           <td width="87%" height="25" colspan="3" class="bg_04"><input size=45 type="text" name="ref_name" readonly>
		...
		<%
			for(int i=1; i<attache_cnt; i++) {
				out.println("<input type=file name=attachfile"+i+" size=45><br>");
			}
		%>		   
		   </td></tr>
		 <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
...
{
	wopen("searchRefDocument.jsp?target_id=eForm.ref_id&target_name=eForm.ref_name","ref_id","520","310","scrollbars=auto,toolbar=no,status=no,resizable=yes");

}
//부서명 찾기
function searchDivision()
{
	wopen("searchDivision.jsp?target=eForm.dest_ac_name","division","520","465","scrollbars=auto,toolbar=no,status=no,resizable=yes");
...
function eleApprovalRequest()
{
	...
	document.eForm.mode.value='HYEOPJO';	
...
function eleApprovalTemp()
{
	...
	document.eForm.action="../../../servlet/JiWeonServlet";
	document.eForm.mode.value='HYEOPJO_TMP';
