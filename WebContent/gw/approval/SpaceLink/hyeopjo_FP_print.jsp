...
<%
	...
	//*********************************************************************
	// 결재선 내용 받기 (결재선과 note사항 분리하기 포함시적용)
	//*********************************************************************
...
<TR>
	...
	<TD width='30%' align="middle" class="title2"> 협조전</TD>
...
<!-- 결재정보 시작 -->
<TABLE cellSpacing=0 cellPadding=0 border=1 width="620"  bordercolordark="white" bordercolorlight="#9CA9BA">
<TBODY>
	<TR vAlign=middle height=23>
		...
		<TD noWrap width=60 align=middle class="bg_07">기안자</TD>
		<TD noWrap width=60 align=middle class="bg_07">검토자</TD>
		<TD noWrap width=60 align=middle class="bg_07">승인자</TD></TR>
...
<TABLE cellSpacing=0 cellPadding=0 width="620" border=0>
	<tr><td>
		<TABLE cellSpacing=0 cellPadding=0 width="620" border=1 bordercolordark="white" bordercolorlight="#9CA9BA">
			...
			<tr>
				<td width="15%" height="25" align="middle" class="bg_05">수신부서</td>
				<td width="35%" class="bg_06"><%=dest_ac_name%>&nbsp;</td>
				<td width="15%" height="25" align="middle" class="bg_05">발신부서</td>
				<td width="35%" class="bg_06"><%=div_name%>&nbsp;</td></tr>	
			<tr>
			...
			<tr>
				<td width="15%" height="25" align="middle" class="bg_05">작성자</td>
				<td width="85%" class="bg_06" colspan="3"><%=user_name%>&nbsp;</td></tr>
			<tr>
			...
			<tr>
				<td width="15%" height="25" align="middle" class="bg_05">관련근거</td>
				<td width="85%" class="bg_06" colspan="3"><%=ref_name%>&nbsp;</td></tr>
			<tr>
