...
<TR>
	...
	<TD width='30%' align="middle" class="title2">출장보고서</TD>
...
<TBODY>
	...
	<TR>
		...
		<TD noWrap align=left colspan="5"><%=line_note%>&nbsp;</TD>
	</TR>
	</TBODY>
</TABLE>
...
<TABLE cellSpacing=0 cellPadding=0 width="620" border=0>
	<tr><td>
		<TABLE cellSpacing=0 cellPadding=0 width="620" border=1 bordercolordark="white" bordercolorlight="#9CA9BA">
		<tr>
				<td width="15%" height="25" align="middle" class="bg_05">보고일자</td>
				<td width="85%" class="bg_06" colspan="3"><%=wyear%>년 <%=wmonth%>월 <%=wdate%>일</td></tr>
			<tr>
			...
			<tr>
				...
				<td width="35%" class="bg_06"><%=destination%>&nbsp;</td>
				<td width="15%" height="25" align="middle" class="bg_05">출장목적</td>
				<td width="35%" class="bg_06"><%=purpose%>&nbsp;</td></tr>				
			<tr>
				<td width="15%" height="25" align="middle" class="bg_05">출장내용</td>
				<td width="85%" class="bg_06" colspan="3"><pre><%=read_con%></pre></td></tr>
			<tr>
				<td width="15%" height="25" align="middle" class="bg_05">첨부화일</td>
