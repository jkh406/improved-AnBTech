...
<TR>
	...
	<TD width='30%' align="middle" class="title2">일반보고서</TD>
	...
	<tr><td>
		...
		<tr>
			...
			<tr>
				...
				<td width="35%" class="bg_06"><%=prj_name%>&nbsp;</td>
				<td width="15%" height="25" align="middle" class="bg_05">발주처</td>
				<td width="35%" class="bg_06"><%=ap_name%>&nbsp;</td></tr>				
			<tr>
