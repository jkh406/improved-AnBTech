...
<%
	...
	*********************************************************************/
	...
	String purpose = multi.getParameter("purpose"); if(purpose == null) purpose = "";	//목적
	...
	<table cellspacing=0 cellpadding=2 width="100%" border=0>
	   <tbody>
		 ...
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04"><input size=20 type="text" name="destination" value='<%=destination%>' class='text_01'></td>
           <td width="13%" height="25" class="bg_03" background="../../images/bg-01.gif">출장목적</td>
           <td width="37%" height="25" class="bg_04"><input size=30 type="text" name="purpose" value='<%=purpose%>' class='text_01'></td></tr>
         <tr bgcolor=c7c7c7><td height=1 colspan="4"></td></tr>
		 <tr>
...
<input type='hidden' name='doc_sub' value='[출장보고서]'>
...
function eleApprovalRequest()
{
	...
	if(!document.eForm.destination.value){
		alert('출장지를 입력하십시오.');
		document.eForm.destination.focus();
		return;
	}
	if(!document.eForm.purpose.value){
		alert('출장목적을 입력하십시오.');
		document.eForm.purpose.focus();
		return;
	}
	...
	var doc_sub = "출장보고서 : "+purpose;

	document.onmousedown=dbclick;

	//일괄합의 결재상신진행
	document.eForm.action='../../../servlet/BogoSeoServlet';
	document.eForm.mode.value='R_CHULJANG_BOGO';	
...
function eleApprovalTemp()
{
	...
	document.onmousedown=dbclick;
	document.eForm.action="../../../servlet/BogoSeoServlet";
	document.eForm.mode.value='R_CHULJANG_BOGO_TMP';
