...
<%
	...
	*********************************************************************/	
	...
	estimate_no = doc_id.substring(0,bar);
	ver = doc_id.substring(bar+1,doc_id.length());
	
%>

<html>
<head><title>견적서</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr><td width="100%" height="100%" valign="top">
		<iframe id="iframe_main" src="../../../servlet/EstimateMgrServlet?mode=print&estimate_no=<%=estimate_no%>&ver=<%=ver%>" width="100%" height="100%" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="no"></iframe>
  </td></tr></table>
