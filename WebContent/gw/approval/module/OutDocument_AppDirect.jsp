	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../gw/images/blet.gif"> 사외공문</TD></TR></TBODY>
		</TABLE></TD></TR>
		  ...
		  <TABLE cellSpacing=0 cellPadding=0>
			...
			<TR>
			  ...
			  <TD align=left width=300>
				...
				<a href="../servlet/OutDocumentServlet?mode=OTD_L"><img src="../gw/images/bt_cancel.gif" border="0" align="absmiddle"></a></TD></TR></TBODY></TABLE></TD></TR></TABLE>
