...
<%
	...
	*********************************************************************/	
	...
	String[] odColumn = {"slogan","title_name","subject","sname"};
	bean.setTable("OfficialDocument");			
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../gw/images/blet.gif"> 공지공문</TD></TR></TBODY>
		</TABLE></TD></TR>
		  ...
		  <TABLE cellSpacing=0 cellPadding=0>
			...
			<TR>
			  ...
			  <TD align=left width=300>
				...
				<a href="../servlet/OfficialDocumentServlet?mode=OFD_L"><img src="../gw/images/bt_cancel.gif" border="0" align="absmiddle"></a></TD></TR></TBODY></TABLE></TD></TR></TABLE>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr><td align="center"><iframe id="iframe_main" src="../servlet/OfficialDocumentServlet?mode=ODT_V&id=<%=id%>" width="100%" height="500" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="no">
</iframe></td></tr></table>

<input type='hidden' name='doc_id' value='<%=bean.getID()%>'>
<input type='hidden' name='date' value='<%=anbdt.getTime()%>'>
<input type='hidden' name='doc_sub' value='공지공문 : <%=subject%>'>
...
{
	wopen("../gw/approval/eleApproval_Share.jsp?target=eForm.doc_app_line","eleA_app_search_select","520","467");
}
...
function eleApprovalRequest()
{
	...
	//일괄합의 결재상신진행
	document.eForm.action='../servlet/OfficialDocumentServlet';	
	document.eForm.app_mode.value='REQ';
	document.eForm.mode.value='ODT';
