...
<%
	...
	*********************************************************************/	
	...
	String req_no = doc_id.substring(0,sep_no);				//구매관리번호
	String req_type = doc_id.substring(sep_no+1,len_no);	//구매TYPE (MRP : 생산관리 MRP구매요청)
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../../images/blet.gif"> 구매요청</TD></TR></TBODY>
		</TABLE></TD></TR>
