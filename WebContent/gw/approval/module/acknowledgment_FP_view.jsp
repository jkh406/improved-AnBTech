...
<%
	...
	*********************************************************************/	
	...
	//승인원 관리번호 분리해 찾아내기
	String mode="";			//승인원 종류(report_w:신규등록,repoer_r:사양변경,report_d:삭제요청)
	String no = "";			//승인원 관리번호
	int bar = doc_id.indexOf("|");
	no = doc_id.substring(0,bar);
	mode = doc_id.substring(bar+1,doc_id.length());
	
%>

<html>
<head><title>승인원</title>
