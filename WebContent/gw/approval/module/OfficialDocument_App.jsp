	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../../images/blet.gif"> 공지공문</TD></TR></TBODY>
		</TABLE></TD></TR>
...
{
	wopen("../eleApproval_Share.jsp?target=eForm.doc_app_line","eleA_app_search_select","560","467");
}
