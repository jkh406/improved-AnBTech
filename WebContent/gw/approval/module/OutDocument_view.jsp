...
<%
	...
	*********************************************************************/	
	...
	String tel="";					//TEL
	String fax="";					//FAX
	String[] odColumn = {"slogan","title_name","address","tel","fax"};
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr><td align="center"><iframe id="iframe_main" src="../../../servlet/OutDocumentServlet?mode=ODS_V&id=<%=doc_id%>" width="100%" height="500" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="no">
</iframe></td></tr></table>
