...
<%
	...
	*********************************************************************/	
	...
	String enter_no = request.getParameter("enter_no");	if(enter_no == null) enter_no = "";		//구매입고번호
	...
	*********************************************************************/	
	...
	String project_name="부품발주";	//프로젝트명
	String subject = "";			//제목
	
	subject = project_name+" 에 대한 구매입고 결재상신";
%>
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../../images/blet.gif"> 구매입고 결재상신</TD></TR></TBODY>
		</TABLE></TD></TR>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr><td align="center"><iframe id="iframe_main" src="../../../servlet/PurchaseMgrServlet?mode=enter_app_view&enter_no=<%=enter_no%>" width="100%" height="500" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="no">
</iframe></td></tr></table>

<input type='hidden' name='doc_id' value='<%=bean.getID()%>'>
<input type='hidden' name='date' value='<%=anbdt.getTime()%>'>
<input type='hidden' name='doc_sub' value='구매입고 : <%=subject%>'>
...
<input type='hidden' name='enter_no' value='<%=enter_no%>'>			<% //구매입고번호 %>
...
function eleApprovalRequest()
{
	...
	document.eForm.mode.value='app_enter';
