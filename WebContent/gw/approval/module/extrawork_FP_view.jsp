...
<%
	...
	*********************************************************************/	
	...
	//특근신청 관리번호  찾아내기
	String mno = "";			//특근신청 관리번호
	mno = doc_id;
	
%>

<html>
<head><title>특근신청</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr><td align="center"><iframe id="iframe_main" src="../../../servlet/ExtraWorkServlet?mode=ew_req_view&mno=<%=mno%>" width="100%" height="500" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="no">
</iframe></td></tr></table>
