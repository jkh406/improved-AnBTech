...
<%
	...
	*********************************************************************/	
	...
	String mno  = request.getParameter("mno");			if(mno == null) mno = "";	//특근 관리번호
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../../images/blet.gif"> 특근신청</TD></TR></TBODY>
		</TABLE></TD></TR>
		  ...
		  <TABLE cellSpacing=0 cellPadding=0>
			...
			<TR>
			  ...
			  <TD align=left width=300>
				...
				<a href="Javascript:extraWorkReqList();"><img src="../../images/bt_cancel.gif" border="0" align="absmiddle"></a></TD></TR></TBODY></TABLE></TD></TR></TABLE>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr><td align="center"><iframe id="iframe_main" src="../../../servlet/ExtraWorkServlet?mode=ew_req_view&ono_plus=<%=ono_plus%>" width="100%" height="500" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="no">
</iframe></td></tr></table>
...
<input type='hidden' name='ono_plus' value='<%=ono_plus%>'>
</form>  
...
function eleApprovalRequest()
{
	...
	//일괄합의 결재상신진행
	document.eForm.action='../../../servlet/ExtraWorkAppServlet';	
