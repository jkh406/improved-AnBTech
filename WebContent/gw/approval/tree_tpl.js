...
var img_url = '../gw/approval/icons/';
var tree_tpl = {
	'target'  : 'view',	// name of the frame links will be opened in
	...
	'icon_0'  : img_url + 'folder.gif', // leaf icon normal
	'icon_4'  : img_url + 'folderopen.gif', // leaf icon selected
	'icon_8'  : img_url + 'folderopen.gif', // leaf icon opened
	'icon_12' : img_url + 'folderopen.gif', // leaf icon selected
