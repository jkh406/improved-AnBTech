...
<%@ page
	...
	import		= "java.util.*,com.anbtech.ca.entity.*,com.anbtech.admin.SessionLib"
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../ca/images/blet.gif"> 승인취소의뢰</TD></TR></TBODY>
		</TABLE></TD></TR>
		  ...
		  <TABLE cellSpacing=0 cellPadding=0>
			...
			<TR>
			  ...
			  <TD align=left width=500>
					<a href="javascript:checkForm();"><img src="../ca/images/bt_save.gif" border="0" align="absmiddle"></a>
					<a href="javascript:history.go(-1);"><img src="../ca/images/bt_cancel.gif" border="0" align="absmiddle"></a>
			  </TD></TR></TBODY></TABLE></TD></TR></TABLE>

<!--내용-->
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr><td align="center"><form method=post name="writeForm" action='../servlet/ComponentApprovalServlet' enctype='multipart/form-data' style="margin:0">
	<!--취소정보-->
	<table cellspacing=0 cellpadding=2 width="100%" border=0>
	   <tbody>
         <tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
		 <tr>
           <td width="13%" height="25" class="bg_03" background="../ca/images/bg-01.gif">취소의뢰자</td>
           <td width="37%" height="25" class="bg_04"><%=division%>/<%=name%>/<%=id%></td>
           <td width="13%" height="25" class="bg_03" background="../ca/images/bg-01.gif">취소의뢰일자</td>
           <td width="37%" height="25" class="bg_04"><%=w_time%></td></tr>
         <tr bgcolor=c7c7c7><td height=1 colspan="4"></td></tr>
		 <tr>
           <td width="13%" height="25" class="bg_03" background="../ca/images/bg-01.gif">승인취소사유</td>
           <td width="87%" height="25" colspan="3" class="bg_04"><textarea rows="5" name="change_info" cols="80" class="text_01"></textarea></td></tr>
		 <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
...
function checkForm(){
	...
	if(f.change_info.value.length < 10){
		alert("승인취소의뢰 사유를 입력하십시오.(10자 이상)");
		f.change_info.focus();
		return;
	}
	f.submit();
