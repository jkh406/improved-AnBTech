...
<TABLE cellSpacing=0 cellPadding=0 width=175 border=0 background='images/lm_bg.gif' height='100%' valign='top'>
  ...
  <TR><!--견적서검색 -->
    <TD onmouseover="menu1.src='images/lm_em1_over.gif'" 
    style="CURSOR: hand" onclick=showhide(1);subhideall()
    onmouseout="menu1.src='images/lm_em1.gif'"><A 
      href="../servlet/EstimateMgrServlet?mode=list" target=up><IMG src="images/lm_em1.gif" border=0 
      name=menu1></A></TD></TR>
  <TR>
  ...
  <TR><!--견적서작성 -->
    <TD onmouseover="menu2.src='images/lm_em2_over.gif'" 
    style="CURSOR: hand" onclick=showhide(2);subhideall();
    onmouseout="menu2.src='images/lm_em2.gif'"><A href="../servlet/EstimateMgrServlet?mode=write" target="up"><IMG src="images/lm_em2.gif" border=0 
    name=menu2></A></TD></TR>
  <TR>
    <TD><SPAN id=block2 style="DISPLAY: none; xCURSOR: hand"></SPAN></TD></TR>

  <TR><!--마이폴더 -->
    <TD onmouseover="menu3.src='images/lm_em3_over.gif'" 
    style="CURSOR: hand" onclick=showhide(3);subhideall();
    onmouseout="menu3.src='images/lm_em3.gif'"><A href="../servlet/EstimateMgrServlet?mode=mylist" target="up"><IMG src="images/lm_em3.gif" border=0 
      name=menu3></A></TD></TR>
  <TR>
      ...
      border=0>
        ...
        <TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
            ...
            href="../servlet/EstimateMgrServlet?mode=list_out_item" target=up><SPAN id=m4_1>견적품목등록관리</SPAN></A> </TD></TR>
        <TR>
        ...
        <TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
            ...
            href="admin/input_item_mgr.jsp?mode=admin" target=up><SPAN id=m4_2>견적서입력항목관리</SPAN></A> </TD></TR></TBODY></TABLE></SPAN></TD></TR>
<%	}else{	%>
