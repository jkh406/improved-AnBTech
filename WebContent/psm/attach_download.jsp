...
<%@ page language="java" 
	...
	import="java.sql.*,java.util.*,com.anbtech.text.Hanguel" contentType="text/html;charset=KSC5601" %>
<%							
	...
	String extend = request.getParameter("extend");			//저장 확장 path

	String downFile		= upload_path+extend+"/addfile/"+savename;					
