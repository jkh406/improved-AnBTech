...
%>
<HTML>
<HEAD><TITLE>과제상태별 색상<%=caption%></TITLE>
	...
	<TR>
		<TD height=27><!--타이틀-->
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../images/blet.gif"> 과제상태별 색상 <%=caption%></TD>
		...
		<TABLE cellspacing=0 cellpadding=2 width="100%" border=0>
			...
			<TR>
			   ...
			   <TD width="37%" height="25" class="bg_04">
					...
					%></select></TD>
			   <TD width="13%" height="25" class="bg_03" background="../images/bg-01.gif">색상(영문)</TD>
			   <TD width="37%" height="25" class="bg_04">
					<INPUT type="text" name="env_name" maxlength='30' value="<%=env_name%>" size="15"></TD>
			</TR>
...
<INPUT type="hidden" name="env_type" value='C'>
</FORM> 
</BODY>
</HTML>
...
function write()
{
	...
	if(env_name == '') { alert('색상명을 입력하십시오.'); f.env_name.focus(); return; }

	var pid = f.pid.value;
	if(pid != '') { alert('수정버튼을 이용하십시오.'); return; }

	document.sForm.action='colorMgrProcess.jsp';
...
{
	document.sForm.action='colorMgrList.jsp';
	document.onmousedown=dbclick;
	document.sForm.submit();
}
...
{
	document.vForm.action='colorMgrInput.jsp';
