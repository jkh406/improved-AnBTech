...
<%
	...
	*********************************************************************/
	if(mode.equals("ADD")) {
		...
		//조건에따라 등록하기
		if(sts.equals(env_status)) { msg = "이미 등록된 정보입니다."; }
		else {
	...
	<TR>
		<TD height=27><!--타이틀-->
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../images/blet.gif"> 진행색상관리</TD>
				</TR>
				</TBODY>
			</TABLE>
		</TD>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 valign='top'>
	...
	%>	
		...
		<TR onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
			...
			<TD align=left height="24" class='list_bg'><a href="javascript:contentView('<%=data[i][0]%>');"><%=data[i][2]%></a></TD>
			<TD><IMG height=1 width=1></TD>
...
function write()
{
	...
	document.sForm.action='colorMgr.jsp';
...
{
	document.vForm.action='colorMgr.jsp';
