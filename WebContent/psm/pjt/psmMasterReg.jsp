...
<%
	...
	if(psm_view.equals("VM")) link_code = str.repWord(link_code,",",",\n");
	...
	if(psm_status.equals("11")) title = "과제정보등록확정";	

	//단독과제 및 복합과제[메인과제,서브과제] 제목달기
	String m_title = "MAIN과제";
	if(psm_view.equals("VM")) m_title = "SUB과제";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<table cellspacing=0 cellpadding=2 width="100%" border=0>
			<tbody>
			<tr>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">작성자</td>
			   <td width="35%"" height="25" class="bg_04"><%=psm_user%>
					<input type="hidden" name="psm_user" value="<%=psm_user%>" size="20"></td>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">작성일</td>
			   <td width="35%"" height="25" class="bg_04"><%=reg_date%>
					<input type="hidden" name="reg_date" value="<%=reg_date%>" size="30"></td>
			</tr>
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">과제코드</td>
			   <td width="35%"" height="25" class="bg_04"><%=psm_code%>
					<input class='text_01' type='hidden' name='psm_code' value='<%=psm_code%>'></td>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">과제종류</td>
			...
			<tr>
			   ...
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif"><%=m_title%></td>
			   <td width="35%"" height="25" class="bg_04">
					<TEXTAREA NAME='link_code' rows=1 cols=18 style='border:1px solid #787878;' readonly><%=link_code%></TEXTAREA>
				<% if(icon.equals("E") && !psm_view.equals("VM")) { %>
					<a href="javascript:searchProject();"><img src="../psm/images/bt_search.gif" border="0" align='absbottom'></a>
					<a href="javascript:deleteProject();"><img src="../psm/images/bt_del.gif" border="0" align='absbottom'></a>
				<% } %></td>
			</tr>
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   ...
			   <td width="35%" height="25" class="bg_04">
					<input class='text_01' type='text' name='pd_code' value='<%=pd_code%>' readonly>
				<% if(icon.equals("E")) { %>
					<a href="javascript:searchProductInfo();"><img src="../psm/images/bt_search.gif" border="0" align='absbottom'></a>
				<% } %></td>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">제품명</td>
			   <td width="35%" height="25" class="bg_04">
					<input class='text_01' type='text' name='pd_name' value='<%=pd_name%>' readonly></td>
			</tr>
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">과제고객</td>
			   <td width="35%" height="25" class="bg_04">
				...
				<% } %></td>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">과제카테고리</td>
			   <td width="35%" height="25" class="bg_04">
					<input class='text_01' type='text' name='comp_category' value='<%=comp_category%>' readonly></td>
			</tr>
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">과제명(한글)</td>
			   <td width="35%"" height="25" class="bg_04">
					<input class='text_01' type='text' name='psm_korea' maxlength='50' value='<%=psm_korea%>' <%=rd%>></td>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">과제명(영문)</td>
			   <td width="35%"" height="25" class="bg_04">
					<input class='text_01' type='text' name='psm_english' maxlength='50' value='<%=psm_english%>' <%=rd%>></td>
			</tr>
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">과제시작일</td>
			   <td width="35%"" height="25" class="bg_04">
				...
				<% } %></td>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">과제완료일</td>
			   <td width="35%"" height="25" class="bg_04">
			...
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">과제담당자</td>
			   <td width="35%"" height="25" class="bg_04">
				...
				<% } %></td>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">예산담당자</td>
			   <td width="35%"" height="25" class="bg_04">
			...
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">과제PM</td>
			   <td width="35%"" height="25" class="bg_04">
				...
				<% } %></td>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif" rowspan=3>과제설명</td>
			   <td width="35%"" height="25" class="bg_04" rowspan=3>
					<TEXTAREA class='text_01' NAME='psm_desc' rows=3 cols=42 style='border:1px solid #787878;' <%=rd%>><%=psm_desc%></TEXTAREA></td>
			</tr>
			<tr bgcolor="c7c7c7"><td height=1 colspan="2"></td></tr>
			<tr>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">진행상태</td>
			   <td width="35%"" height="25" class="bg_04">
			...
			<tr>
				...
				<td width="10%" height="25" class="bg_03" background="../psm/images/bg-01.gif">용역비</td>
				<td width="40%" height="25" class="bg_04">
			...
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">계약명</td>
			   <td width="35%"" height="25" class="bg_04">
					<input class='text_01' type='text' name='contract_name' maxlength='100' value='<%=contract_name%>' <%=rd%>></td>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">계약일</td>
			   <td width="35%"" height="25" class="bg_04">
			...
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">계약금액</td>
			   <td width="35%"" height="25" class="bg_04">
					...
					<input type=text name=contract_price_money style="border:1px;background-color:#ffffff;text-align:right;color:#FF0033" readonly size=20> 원</td>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">납기일자</td>
			   <td width="35%"" height="25" class="bg_04">
			...
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="15%" height="25" class="bg_03" background="../psm/images/bg-01.gif">첨부파일</td>
...
<input type='hidden' name='psm_view' value='<%=psm_view%>'>
<input type='hidden' name='psm_kind' value='<%=psm_kind%>'>
</form>
...
function sendSave()
{
	...
	if(env_status == '2') {		//정식과제
		...
		var contract_date = f.contract_date.value;
		if(contract_date == '') { alert('계약일자가 입력되지 않았습니다. '); f.contract_name.focus(); return; }

		var complete_date = f.complete_date.value;
		if(complete_date == '') { alert('납기일자가 입력되지 않았습니다. '); f.contract_name.focus(); return; }
	}
...
function sendModify()
{
	...
	var link_code = f.link_code.value;
	if(psm_code == link_code) { alert('자신이 자신을 MAIN과제로 등록될 수 없습니다.'); return; }
	...
	document.eForm.link_code.value=link_code;
	document.eForm.plan_sum.value=psum;
	document.eForm.plan_labor.value=plab;
	document.eForm.plan_material.value=pmat;
	document.eForm.plan_cost.value=pcst;
...
function searchProject() {
	...
	para = "&target=eForm.link_code/eForm.link_name/eForm.pd_code/eForm.pd_name/eForm.comp_name/";
	para +="eForm.comp_category/eForm.contract_date/eForm.contract_name/eForm.contract_price/";
	para +="eForm.complete_date";
	wopen('../servlet/PsmProcessServlet?mode=search_single'+para,'search_pjt','400','228','scrollbars=no,toolbar=no,status=no,resizable=no');
}
// 과제코드 삭제하기
function deleteProject() {
	
	document.eForm.link_code.value="";
	document.eForm.link_name.value="";
}
//창
