...
<TABLE cellSpacing=0 cellPadding=0 width=175 border=0 background='images/lm_bg.gif' height='100%' valign='top'>
  ...
  <TR>
    <TD onmouseover="menu1.src='images/**.gif'" 
    style="CURSOR: hand" onclick="showhide(1);subhideall()" onmouseout="menu1.src='images/**.gif'">
	<A href="../servlet/PsmBaseInfoServlet?mode=psm_bylist" target="view">
	<IMG src="images/lm_bm1.gif" border=0 name=menu1 alt='과제정보등록'></A></TD></TR>
  <TR>
   ...
   <TR>
	...
	<A href="../servlet/PsmBaseInfoServlet?mode=psm_bylist" target="view">
	<IMG src="images/lm_bm2.gif" border=0 name=menu2 alt='과제정보등록확정'></A></TD></TR>
  <TR>
  ...
  <TR>
	...
	<IMG src="images/lm_bm3.gif" border=0 name=menu3 alt='과제정보조회'></A></TD></TR>
  <TR>
	...
	<TR>
		<TD align='center' height='5' valign='middle' bgcolor='#cccccc'></TD></TR>  
		<TD onmouseover="menu4.src='images/lm_bm2_over.gif'" 
		...
		<IMG src="images/lm_bm4.gif" border=0 name=menu4 alt='과제상태관리'></A></TD></TR>
	  <TR>
  ...
  %>
  <TR><!--관리자 설정 -->
    <TD onmouseover="menu5.src='images/lm_***.gif'" 
    style="CURSOR: hand" onclick="showhide(5);subhideall();selectedtext(5,1)" 
    onmouseout="menu5.src='images/**.gif'"><IMG src="images/lm_***.gif" border=0 
