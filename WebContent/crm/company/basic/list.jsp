    ...
    <TD vAlign=top>
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../crm/images/blet.gif" align="absmiddle"> 고객사정보 검색</TD>
			...
			<TR>
			  ...
			  <TD align=left width='70'><form method='get' action='../servlet/CrmServlet' name='srForm' style="margin:0">
				  <select name="searchscope" onChange="sel_scope();">
						<option value='company_name'>고객사명</option>
					...
					<div id="scope1" class="collapsed" style="position:relative;">
						<table cellSpacing=0 cellPadding=0 width="100%" border='0'>
						  <tr><td>
							...
							</select></td><td width='100%'>&nbsp;<a href="javascript:checkForm();"><img src="../crm/images/bt_search3.gif" border="0"></a> <a href="../servlet/CrmServlet?mode=company_write&module=basic"><img src="../crm/images/bt_add_new2.gif" border="0"></a></td></tr></table></div>
		...
		%>							
					...
					<div id="scope3" class="expanded" style="position:relative;">
						<table cellSpacing=0 cellPadding=0 width="100%" border='0'><tr><td>
						   <input type="text" name="searchword" size="10" onFocus="document.srForm.searchword.value==''"></td><td width='100%'>&nbsp;<a href="javascript:checkForm();"><img src="../crm/images/bt_search3.gif" border="0"></a> <a href="../servlet/CrmServlet?mode=company_write&module=basic"><img src="../crm/images/bt_add_new2.gif" border="0"></a></td></tr></table></div>
	  ...
	  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0><form name='listForm' style='magrgin:0'>
        <TBODY>
			<TR vAlign=middle height=22>
			  ...
			  <TD noWrap width=100% align=middle class='list_title'>고객사명1</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../crm/images/list_tep.gif"></TD>
			  <TD noWrap width=200 align=middle class='list_title'>고객사명2</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../crm/images/list_tep.gif"></TD>
