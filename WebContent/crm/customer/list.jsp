...
<%
	...
	customer_list = (ArrayList)request.getAttribute("CustomerList");
	customer = new CustomerInfoTable();
	Iterator customer_iter = customer_list.iterator();
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0 valign="top">
    ...
    <TD vAlign=top>
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../crm/images/blet.gif" align="absmiddle"> 고객정보 검색</TD>
  ...
  <TR height=32><!--버튼 및 페이징-->
    <TD vAlign=top>
			...
			<TR>
			  ...
			  <TD align=left width='70'><form method='get' action='../servlet/CrmServlet' name='srForm' style="margin:0">
				  <select name="searchscope" onChange="sel_scope();">
						...
						<option value='customer_type'>고객유형</option>
						<option value='customer_class'>고객분류</option>
						<option value='comp_name'>고객사명</option>
				  </select>&nbsp;</TD>
					...
					<div id="scope1" class="collapsed" style="position:relative;">
						<table cellSpacing=0 cellPadding=0 width="100%" border='0'>
						  <tr><td>
							...
							</select></td><td width='100%'>&nbsp;<a href="javascript:checkForm();"><img src="../crm/images/bt_search3.gif" border="0"></a> <a href="../servlet/CrmServlet?mode=customer_write"><img src="../crm/images/bt_add_new2.gif" border="0"></a></td></tr></table></div>
		...
		%>							
							</td><td><a href="javascript:checkForm();"><img src="../crm/images/bt_search3.gif" border="0"></a> <a href="../servlet/CrmServlet?mode=customer_write"><img src="../crm/images/bt_add_new2.gif" border="0"></a></td></tr></table></div>
					<div id="scope3" class="expanded" style="position:relative;">
						<table cellSpacing=0 cellPadding=0 width="100%" border='0'><tr><td>
						   <input type="text" name="searchword" size="10" onFocus="document.srForm.searchword.value==''"></td><td width='100%'>&nbsp;<a href="javascript:checkForm();"><img src="../crm/images/bt_search3.gif" border="0"></a> <a href="../servlet/CrmServlet?mode=customer_write"><img src="../crm/images/bt_add_new2.gif" border="0"></a></td></tr></table></div>
	  ...
	  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0><form name='listForm' style='magrgin:0'>
        <TBODY>
			<TR vAlign=middle height=22>
			  <TD noWrap width=100 align=middle class='list_title'>고객명</TD>
			  ...
			  <TD noWrap width=6 class='list_title'><IMG src="../crm/images/list_tep.gif"></TD>
			  <TD noWrap width=120 align=middle class='list_title'>회사전화</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../crm/images/list_tep.gif"></TD>
			  <TD noWrap width=120 align=middle class='list_title'>휴대전화</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../crm/images/list_tep.gif"></TD>
			  <TD noWrap width=100% align=middle class='list_title'>회사</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../crm/images/list_tep.gif"></TD>
			  <TD noWrap width=200 align=middle class='list_title'>전자우편</TD>
		   </TR>
			<TR bgColor=#9DA9B9 height=1><TD colspan=11></TD></TR>
<%
	while(customer_iter.hasNext()){
		customer = (CustomerInfoTable)customer_iter.next();
%>
			<TR onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
			  <TD align=middle height="24" class='list_bg'><%=customer.getNameKor()%></td>
			  <TD><IMG height=1 width=1></TD>
			  <TD align=middle class='list_bg'><%=customer.getPositionRank()%></td>
			  <TD><IMG height=1 width=1></TD>
			  <TD align=middle class='list_bg'><%=customer.getCompanyTelNo()%></td>
			  <TD><IMG height=1 width=1></TD>
			  <TD align=middle class='list_bg'><%=customer.getMobileNo()%></td>
			  <TD><IMG height=1 width=1></TD>
			  <TD align=middle class='list_bg'>&nbsp;<%=customer.getCompanyName()%></td>
			  <TD><IMG height=1 width=1></TD>
			  <TD align=middle class='list_bg'><%=customer.getEmailAddress()%></td>
			</TR>
...
<script language='javascript'>
	...
	function checkForm(){
		...
		if(f.searchscope.value == 'customer_type'){
		...
		}else if(f.searchscope.value == 'customer_class'){
			var items = "";
			var s_count = 0;
