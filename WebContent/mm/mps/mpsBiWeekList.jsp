...
<%
	...
	*********************************************************************/
	...
	while(table_iter.hasNext()) {
		...
		if(Pd7.equals(pde))  Pc7 += "<A Href=../servlet/mpsInfoServlet?mode=mps_view&factory_no="+factory_no+"&pid="+pid+" onMouseOver=\"window.status='일정 상세보기';return true;\" onMouseOut=\"window.status='';return true;\">"+fcd+"("+pct+")&nbsp;&nbsp;"+cnt+"</font>" + "</A><br>";
		if(Pd8.equals(pde))  Pc8 += "<A Href=../servlet/mpsInfoServlet?mode=mps_view&factory_no="+factory_no+"&pid="+pid+" onMouseOver=\"window.status='일정 상세보기';return true;\" onMouseOut=\"window.status='';return true;\">"+fcd+"("+pct+")&nbsp;&nbsp;"+cnt+"</font>" + "</A><br>";
		if(Pd9.equals(pde))  Pc9 += "<A Href=../servlet/mpsInfoServlet?mode=mps_view&factory_no="+factory_no+"&pid="+pid+" onMouseOver=\"window.status='일정 상세보기';return true;\" onMouseOut=\"window.status='';return true;\">"+fcd+"("+pct+")&nbsp;&nbsp;"+cnt+"</font>" + "</A><br>";
		if(Pd10.equals(pde)) Pc10 +="<A Href=../servlet/mpsInfoServlet?mode=mps_view&factory_no="+factory_no+"&pid="+pid+" onMouseOver=\"window.status='일정 상세보기';return true;\" onMouseOut=\"window.status='';return true;\">"+fcd+"("+pct+")&nbsp;&nbsp;"+cnt+"</font>" + "</A><br>";
		if(Pd11.equals(pde)) Pc11 +="<A Href=../servlet/mpsInfoServlet?mode=mps_view&factory_no="+factory_no+"&pid="+pid+" onMouseOver=\"window.status='일정 상세보기';return true;\" onMouseOut=\"window.status='';return true;\">"+fcd+"("+pct+")&nbsp;&nbsp;"+cnt+"</font>" + "</A><br>";
		if(Pd12.equals(pde)) Pc12 +="<A Href=../servlet/mpsInfoServlet?mode=mps_view&factory_no="+factory_no+"&pid="+pid+" onMouseOver=\"window.status='일정 상세보기';return true;\" onMouseOut=\"window.status='';return true;\">"+fcd+"("+pct+")&nbsp;&nbsp;"+cnt+"</font>" + "</A><br>";
		if(Pd13.equals(pde)) Pc13 +="<A Href=../servlet/mpsInfoServlet?mode=mps_view&factory_no="+factory_no+"&pid="+pid+" onMouseOver=\"window.status='일정 상세보기';return true;\" onMouseOut=\"window.status='';return true;\">"+fcd+"("+pct+")&nbsp;&nbsp;"+cnt+"</font>" + "</A><br>";
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			<TBODY>
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../mm/images/blet.gif"> <%=factory_no%>공장 2주간 생산계획일정</TD></TR></TBODY>
		</TABLE></TD></TR>
		...
		<TABLE cellSpacing=0 cellPadding=0>
			<TBODY>
				<TR>
					...
					<TD width=7 align='center'><IMG src="../mm/images/11.gif"></TD>
					<TD align=left width=30><a href="../servlet/mpsInfoServlet?mode=list_week2&view_td=<%=view_td%>&factory_no=<%=factory_no%>" onMouseOver="window.status='2주간일정계획';return true;" onMouseOut="window.status='';return true;"><img src="../mm/images/view_2w_o.gif" border="0"></TD>
					<TD width=7 align='center'><IMG src="../mm/images/11.gif"></TD>
					<TD align=left width=30><a href="../servlet/mpsInfoServlet?mode=list_month&view_td=<%=view_td%>&factory_no=<%=factory_no%>" onMouseOver="window.status='월간일정리스트';return true;" onMouseOut="window.status='';return true;"><img src="../mm/images/view_p.gif" border="0"></a></TD>
					<TD width=7 align='center'><IMG src="../mm/images/11.gif"></TD>
