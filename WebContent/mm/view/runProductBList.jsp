...
<HTML><HEAD><TITLE>재공품 불량현황 LIST</TITLE>
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><IMG src="../mm/images/blet.gif"> 재공품 불량현황</TD>
	...
	<TR><TD height=32><!--버튼-->
		  <TABLE cellSpacing=0 cellPadding=0 border='0'>
			...
			<TR>
			  ...
			  <TD align=left width=500 style='padding-left:5px;'>
					<IMG src='../mm/images/bt_search3.gif' onClick='javascript:goSearch();' style='cursor:hand' align='absmiddle'>
			  </TD>
			  <TD width='100%' align='right' style="padding-right:10px"><%=view_pagecut%></TD></TR></TBODY></TABLE></TD></TR></TABLE>
 ...
 <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY><TR bgColor=#9DA9B9 height=1><TD colspan=17></TD></TR>
			<TR vAlign=middle height=23>
			  ...
			  <TD noWrap width=6 class='list_title'><IMG src="../mm/images/list_tep2.gif"></TD>
			  <TD noWrap width=90 align=middle class='list_title'>FG코드</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../mm/images/list_tep2.gif"></TD>
			  <TD noWrap width=80 align=middle class='list_title'>공정구분</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../mm/images/list_tep2.gif"></TD>
			  <TD noWrap width=90 align=middle class='list_title'>재공품코드</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../mm/images/list_tep2.gif"></TD>
			  <TD noWrap width=60 align=middle class='list_title'>생산수량</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../mm/images/list_tep2.gif"></TD>
			  <TD noWrap width=60 align=middle class='list_title'>생산양품</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../mm/images/list_tep2.gif"></TD>
			  <TD noWrap width=60 align=middle class='list_title'>불량양품</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../mm/images/list_tep2.gif"></TD>
			  <TD noWrap width=70 align=middle class='list_title'>불량율[%]</TD>
			</TR>
...
%>
			<TR height=23 onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
				...
				<TD><IMG height=1 width=1></TD>
				<TD align=middle class='list_bg'><%=table.getOpCode()%> [<%=table.getOpNickname()%>]</TD>
				<TD><IMG height=1 width=1></TD>
				<TD align=middle class='list_bg'><%=table.getItemCode()%></TD>
				<TD><IMG height=1 width=1></TD>
				<TD align=middle class='list_bg'><%=nfm.toDigits(table.getTotalCount())%></TD>
				<TD><IMG height=1 width=1></TD>
				<TD align=middle class='list_bg'><%=nfm.toDigits(table.getGoodCount())%></TD>
				<TD><IMG height=1 width=1></TD>
				<TD align=middle class='list_bg'><%=nfm.toDigits(table.getBadCount())%></TD>
				<TD><IMG height=1 width=1></TD>
				<TD align=middle class='list_bg'><%=table.getBadRate()%></TD>
				<TD><IMG height=1 width=1></TD>
			</TR>
...
function goSearch()
{
	...
	document.sForm.mode.value='view_run_blist';
