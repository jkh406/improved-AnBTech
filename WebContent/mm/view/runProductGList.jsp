...
<HTML><HEAD><TITLE>재공품 생산현황 LIST</TITLE>
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			<TBODY>
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><IMG src="../mm/images/blet.gif"> 재공품 생산현황</TD>
		...
		<TABLE cellSpacing=0 cellPadding=0>
			<TBODY>
				<TR>
					...
					<TD align=left width=200 style='padding-left:5px;'>
						<IMG src='../mm/images/bt_search3.gif' onClick='javascript:goSearch();' style='cursor:hand' align='absmiddle'>
					</TD>
					<TD width='100%' align='right' style="padding-right:10px"><%=view_pagecut%></TD></TR></TBODY></TABLE>
</TD></TR></TABLE>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY><TR bgColor=#9DA9B9 height=1><TD colspan=17></TD></TR>
			<TR vAlign=middle height=23>
			  ...
			  <TD noWrap width=6 class='list_title'><IMG src="../mm/images/list_tep2.gif"></TD>
			  <TD noWrap width=80 align=middle class='list_title'>생산계획</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../mm/images/list_tep2.gif"></TD>
			  <TD noWrap width=80 align=middle class='list_title'>생산실적</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../mm/images/list_tep2.gif"></TD>
			  <TD noWrap width=70 align=middle class='list_title'>생산율[%]</TD>
			</TR>
...
function goSearch()
{
	...
	document.sForm.mode.value='view_run_glist';
