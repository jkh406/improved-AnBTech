...
<HTML><HEAD><TITLE>생산작업지시대상</TITLE>
	...
	<TR height=27>
		<TD vAlign=top><!-- 타이틀 및 페이지 정보 -->
			...
			<TBODY>
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../mm/images/blet.gif" align="absmiddle"> 생산작업지시대상</TD>
			...
			<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
				<TBODY>
					...
					<TR vAlign=middle height=23>
						...
						<TD noWrap width=6 class='list_title'><IMG src="../mm/images/list_tep2.gif"></TD>
						<TD noWrap width=100% align=middle class='list_title'>생산품목규격</TD>
						<TD noWrap width=6 class='list_title'><IMG src="../mm/images/list_tep2.gif"></TD>
...
%>
					<TR height=23 onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
						...
						<TD><IMG height=1 width=1></TD>
						<TD align=middle class='list_bg'><%=anbdt.getSepDate(table.getPlanDate(),"-")%></td>
						<TD><IMG height=1 width=1></TD>
...
function goSearch()
{
	...
	document.sForm.mode.value='mfg_request';
...
{
	document.sForm.action='../servlet/mfgInfoServlet';
	document.sForm.mode.value='mfg_presave';
