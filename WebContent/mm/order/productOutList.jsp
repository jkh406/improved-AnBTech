...
<%
	...
	table_list = (ArrayList)request.getAttribute("PRODUCT_MASTER_List");
	table = new mfgProductMasterTable();
	Iterator table_iter = table_list.iterator();
	
%>

<HTML><HEAD><TITLE>생산실적현황</TITLE>
	...
	<TR height=27>
		<TD vAlign=top><!-- 타이틀 및 페이지 정보 -->
			...
			<TBODY>
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../mm/images/blet.gif" align="absmiddle"> 생산실적현황</TD>
		...
		<TD vAlign=top>
			...
			<TBODY>
				...
				<TD align=left width='80%' style="padding-left:10px">
					...
					<%
						String[] sitems = {"mfg_no","item_code"};
						String[] snames = {"생산지시번호","제품코드"};
						String sel = "";
			...
			<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
				<TBODY>
					...
					<TR vAlign=middle height=23>
						...
						<TD noWrap width=6 class='list_title'><IMG src="../mm/images/list_tep2.gif"></TD>
						<TD noWrap width=60 align=middle class='list_title'>주문수량</TD>
						<TD noWrap width=6 class='list_title'><IMG src="../mm/images/list_tep2.gif"></TD>
...
<%
	while(table_iter.hasNext()){
		...
		String status = table.getOutputStatus();
		if(status.equals("1")) status = "등록 중";
		else if(status.equals("2")) status = "실적마감";
...
function goSearch()
{
	...
	document.sForm.mode.value='product_out_list';
	document.sForm.page.value='1';
	document.onmousedown=dbclick;
	document.sForm.submit();
}
//생산실적내용보기
function mfgMasterView(mfg_no,assy_code)
{
	var factory_no = document.sForm.factory_no.value;
	var para = "factory_no="+factory_no+"&mfg_no="+mfg_no+"&assy_code="+assy_code;
