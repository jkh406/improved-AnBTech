	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><IMG src="../st/images/blet.gif"> 생산출고처리대상</TD>
		  ...
		  <TABLE cellSpacing=0 cellPadding=0 border=0>
			<TR>
			  ...
			  <TD align=left width=500>
					<IMG src='../st/images/bt_commit_out.gif' onClick='javascript:enter_selected();' style='cursor:hand' align='absmiddle' alt='출고처리'>	<IMG src='../st/images/bt_cancel.gif' onClick='javascript:history.go(-1);' style='cursor:hand' align='absmiddle' alt='취소'>
...
<!-- 의뢰품목리스트 -->
 <TABLE border=0 width='100%'><TR><TD align=left><IMG src='../st/images/title_todelivery_list.gif' border='0' alt='출고대상품목리스트'></TD></TR></TABLE>
...
%>
			<TR onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
				  <TD align=middle height="24" class='list_bg'><input type='checkbox' name='checkbox' value='<%=table.getDeliveryNo()%>|<%=table.getItemCode()%>|<%=table.getAid()%>'></TD>
...
function enter_selected() {
	...
	var url = "../servlet/StockMgrServlet?mode=delivery_reserved_item_all&items=" + items;
