	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><IMG src="../st/images/blet.gif"> 생산출고의뢰현황</TD>
		  ...
		  <TABLE cellSpacing=0 cellPadding=0 border=0>
			<TR>
			  ...
			  <TD align=left width=500>
					<IMG src='../st/images/bt_sangsin.gif' onClick='javascript:app_selected();' style='cursor:hand' align='absmiddle' alt="선택품목출고결재상신"> <IMG src='../st/images/bt_search3.gif' onClick='javascript:search();' style='cursor:hand' align='absmiddle'>
			  </TD><TD width='300' align='right' style="padding-right:10px"></TD></TR></TABLE></TD></TR></TABLE>
...
<!-- 의뢰품목리스트 -->
 <TABLE border=0 width='100%'><TR><TD align=left><IMG src='../st/images/title_item_req_list.gif' border='0' alt='의뢰품목리스트'></TD></TR></TABLE>
 ...
 <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY><TR bgColor=#9DA9B9 height=1><TD colspan=23></TD></TR>
			<TR vAlign=middle height=23>
			  ...
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=80 align=middle class='list_title'>처리상태</TD>
			</TR>
...
<%	
	//결재 진행중인 상태이거나 결재승인이 완료되었으나 아직 출고가 되지 않은 품목은 다른 결재상신이 이루어지지 않게 한다.
	if(table.getProcessStat().equals("S53") || table.getProcessStat().equals("S59")){	%>
				  <input type='checkbox' name='checkbox' value='<%=table.getDeliveryNo()%>|<%=table.getItemCode()%>|<%=table.getRequestQuantity()%>'>
<%	}	%>				  
				  </TD>
