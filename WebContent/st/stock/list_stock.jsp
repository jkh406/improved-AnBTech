...
<%@ page 
	...
	import		= "java.sql.*, java.io.*, java.util.*,com.anbtech.st.entity.*,java.text.*"
%>
<%!
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><IMG src="../st/images/blet.gif"> 재고현황</TD>
	...
	<TBODY>
		<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04"><input type='text' size='5' name='factory_code' readOnly> <input type='text' size='20' name='factory_name'> <a href="javascript:sel_factory();"><img src="../st/images/bt_search.gif" border="0" align="absmiddle"></a></td>
 ...
 <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY><TR bgColor=#9DA9B9 height=1><TD colspan=19></TD></TR>
			<TR vAlign=middle height=23>
			  ...
			  <TD noWrap width=60 align=middle class='list_title'>공장명</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=80 align=middle class='list_title'>품목코드</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=250 align=middle class='list_title'>품목설명</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=60 align=middle class='list_title'>재고단위</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=80 align=middle class='list_title'>가용수량</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=80 align=middle class='list_title'>입고예정량</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=80 align=middle class='list_title'>출고예정량</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=80 align=middle class='list_title'>현재고수량</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=80 align=middle class='list_title'>최종변경일</TD>
			</TR>
...
<%
	...
	while(table_iter.hasNext()){
		...
		double total_quantity = Double.parseDouble(table.getStockQuantity()) + Double.parseDouble(table.getIntoQuantity()) + Double.parseDouble(table.getOuttoQuantity());
...
%>
			<TR onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
				  ...
				  <TD><IMG height=1 width=1></TD>
				  <TD align=middle class='list_bg'><%=table.getIntoQuantity()%></td>
				  <TD><IMG height=1 width=1></TD>
				  <TD align=middle class='list_bg'><%=table.getOuttoQuantity()%></td>
				  <TD><IMG height=1 width=1></TD>
				  <TD align=middle class='list_bg'><%=df.format(total_quantity)%></td>
				  <TD><IMG height=1 width=1></TD>
...
function search() {
	...
	//alert(where_sea);
	location.href = "StockMgrServlet?mode=list_stock_master&searchscope=detail&searchword=" + where_sea;
}
