	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><IMG src="../st/images/blet.gif"> 재고실사현황</TD>
	...
	<TBODY>
	    ...
	    <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
		 <tr>
           ...
           <td width="37%" height="25" class="bg_04"><input type='text' size='10' name='unit_cost' onKeyPress="currency(this);">원 이상</td>
           <td width="13%" height="25" class="bg_03" background="../st/images/bg-01.gif">Lead Time</td>
           <td width="37%" height="25" class="bg_04"><input type='text' size='3' name='lead_time' onKeyPress="currency(this);">일 이상</td></tr>
	    <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
		 <tr>
 ...
 <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY><TR bgColor=#9DA9B9 height=1><TD colspan=19></TD></TR>
			<TR vAlign=middle height=23>
			  ...
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=50 align=middle class='list_title'>입고<br>예정량</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=50 align=middle class='list_title'>출고<br>예정량</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
...
function search() {
	...
	//alert(where_sea);
	location.href = "StockMgrServlet?mode=list_stock_real&searchscope=detail&searchword=" + where_sea;
}
