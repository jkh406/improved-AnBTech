...
<%
	...
	String resonable_quantity = request.getParameter("resonable_quantity");

	bean.openConnection();
	String sql = "UPDATE st_item_stock_master SET resonable_quantity = '" + resonable_quantity + "' WHERE factory_code = '" + factory_code + "' AND item_code = '" + item_code + "'";
