	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			<TBODY>
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../st/images/blet.gif"> 상세재고이동정보(공장간)</TD></TR></TBODY></TABLE></TD></TR>
...
<TABLE  cellspacing=0 cellpadding=0 width="100%" border=0>
	<TBODY>
		...
		<TR>
           ...
           <TD width="35%" height="25" class="bg_04"><%=table.getSrItemName()%></TR>
	    <TR bgcolor="C7C7C7"><TD height="1" colspan="4"></TD></TR>
		<TR>
           <TD width="15%" height="25" class="bg_03" background="../st/images/bg-01.gif">대상품목설명</TD>
           <TD width="35%" height="25" class="bg_04"><%=table.getSrItemDesc()%></TD>
           <TD width="15%" height="25" class="bg_03" background="../st/images/bg-01.gif">이동수량/단위</TD>
           <TD width="35%" height="25" class="bg_04"><%=table.getQuantity()%> <%=table.getStockUnit()%></TD></TR>
	    <TR bgcolor="C7C7C7"><TD height="1" colspan="4"></TD></TR></TBODY></TABLE><BR>
...
<TABLE  cellspacing=0 cellpadding=0 width="100%" border=0>
	<TBODY>
		...
		<TR>
			...
			<TD width="35%" height="25" class="bg_04"><%=table.getDtFactoryCode()%></TD>
			<TD width="15%" height="25" class="bg_03" background="../st/images/bg-01.gif">이동후공장명</TD>
			<TD width="35%" height="25" class="bg_04"><%=table.getDtFactoryName()%></TD></TR>
