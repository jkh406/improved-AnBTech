...
<%@ include file="../../admin/chk/chkST01.jsp"%>
<%@ page
	language	= "java"
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title">&nbsp;<img src="../../admin/images/blet.gif"> 관리자 설정</TD></TR></TBODY>
		</TABLE></TD></TR>
...
<%
	query = "select name_b,name_s,code_s,owner from prg_privilege where code_b like 'ST%'";
	bean.openConnection();
	bean.executeQuery(query);
	while(bean.next()){
