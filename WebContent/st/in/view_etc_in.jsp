	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../pu/images/blet.gif"> 예외입고상세정보</TD></TR></TBODY>
		</TABLE></TD></TR>
...
<%
			if(inout_type.equals("BI")) out.print("기초재고입고");
			else if(inout_type.equals("RI")) out.print("반품재입고");
			else if(inout_type.equals("AI")) out.print("재고조정입고");
%>
		   </td>		   		   
 ...
 <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY><TR bgColor=#9DA9B9 height=1><TD colspan=13></TD></TR>
			<TR vAlign=middle height=23>
			  ...
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=80 align=middle class='list_title'>입고수량</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=80 align=middle class='list_title'>입고단위</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
...
{ 
	var c = confirm("입고정보 수정은 제한된 내용(첨부파일 등)에 한해서만 가능합니다.\n입고품목 수량을 조정하고자 할때는 신규입고 또는 출고처리를 이용하십시오.\n\n그래도 입고정보를 수정하시겠습니까?");
...
{ 
	if(document.reg.item_no.value >= 2){
		alert("한개 이상의 입고품목이 존재할 경우는 삭제할 수 없습니다.");
		return;
	}
	
	var c = confirm("현재 입고정보를 삭제하시겠습니까?");
