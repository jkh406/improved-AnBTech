...
<%
	...
	String title	= "예외입고정보등록";
	if(mode.equals("update_etc_inout_info")) title = "예외입고정보수정";
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../pu/images/blet.gif"> <%=title%></TD></TR></TBODY>
		</TABLE></TD></TR>
		  ...
		  <TABLE cellSpacing=0 cellPadding=0>
			...
			<TR>
			  ...
			  <TD align=left width=500>
				<img src='../st/images/bt_in_item_add.gif' onClick='javascript:save();' style='cursor:hand' align='absmiddle' alt="입고품목입력"> <a href="javascript:history.go(-1);"><img src='../st/images/bt_cancel.gif' style='cursor:hand' align='absmiddle' alt="취소" border="0"></a>
...
<TABLE  cellspacing=0 cellpadding=0 width="100%" border=0>
	<TBODY>
		<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
		 <tr>
           <td width="13%" height="25" class="bg_03" background="../st/images/bg-01.gif">입고번호</td>
           <td width="37%" height="25" class="bg_04"><input type='text' size='10' name='inout_no' value='<%=inout_no%>' readOnly></td>
           <td width="13%" height="25" class="bg_03" background="../st/images/bg-01.gif">입고일자</td>
           <td width="37%" height="25" class="bg_04"><input type='text' size='10' name='inout_date' value='<%=inout_date%>' class="text_01" readOnly> <a href="Javascript:OpenCalendar('inout_date');"><img src="../pu/images/bt_search.gif" border="0" align="absmiddle"></a></td></tr>
	    <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
		<tr>
           <td width="13%" height="25" class="bg_03" background="../st/images/bg-01.gif">입고유형</td>
           <td width="37%" height="25" class="bg_04">
			<select name='inout_type'>
				<option value=''>선택</option>
				<option value='BI'>기초재고입고</option>
				<option value='RI'>반품재입고</option>
				<option value='AI'>재고조정입고</option>
			</select>
...
<%	}	%></td>		   		   
           <td width="13%" height="25" class="bg_03" background="../st/images/bg-01.gif">입고담당자</td>
...
<!-- 입고품목 -->
 <TABLE border=0 width='100%'><TR><TD align=left><IMG src='../st/images/title_input_item.gif' border='0' alt='입고품목'></TD></TR></TABLE>
 ...
 <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY><TR bgColor=#9DA9B9 height=1><TD colspan=13></TD></TR>
			<TR vAlign=middle height=23>
			  ...
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=100 align=middle class='list_title'>입고수량</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
			  <TD noWrap width=100 align=middle class='list_title'>입고단위</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../st/images/list_tep2.gif"></TD>
...
{
	url = "../admin/config/minor_code/popSystemMinorCode.jsp?sf=reg_order&type=CURRENCY&div=one&code=monetary_unit&type=분류코드&type_name=구분명&code=분류명&code_name=분류설명";
