...
<%
	...
	String inout_type	= request.getParameter("inout_type");	// 입고유형
	...
	<TR><TD height=27><!--타이틀-->
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../st/images/blet.gif"> 예외입고품목등록</TD></TR></TBODY>
		</TABLE></TD></TR>
		  ...
		  <TABLE cellSpacing=0 cellPadding=0>
			...
			<TR>
			  ...
			  <TD align=left width=500>
				<img src='../st/images/bt_save.gif' onClick='javascript:add_item();' style='cursor:hand' align='absmiddle' alt="품목추가"> <a href="../servlet/StockMgrServlet?mode=list_etc_inout&in_or_out=IN"><img src='../st/images/bt_cancel.gif' style='cursor:hand' align='absmiddle' alt="취소" border="0"></a>
...
<TABLE  cellspacing=0 cellpadding=0 width="100%" border=0>
	<TBODY>
	    ...
	    <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
		<tr>
           <td width="13%" height="25" class="bg_03" background="../st/images/bg-01.gif">입고수량</td>
           ...
           <td width="13%" height="25" class="bg_03" background="../st/images/bg-01.gif">입고단위</td>
           <td width="37%" height="25" class="bg_04"><input type='text' size='5' name='item_unit' value='<%=item_unit%>' readOnly></td></tr>
	    <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
		<tr>
           <td width="13%" height="25" class="bg_03" background="../st/images/bg-01.gif">입고단가</td>
           ...
           <td width="13%" height="25" class="bg_03" background="../st/images/bg-01.gif">매입금액</td>
           <td width="37%" height="25" class="bg_04"><input type='text' size='10' name='inout_cost' value='<%=inout_cost%>' readOnly></td></tr>
	    <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
		<tr>
           <td width="13%" height="25" class="bg_03" background="../st/images/bg-01.gif">입고공장</td>
           ...
           <td width="37%" height="25" class="bg_04"><!--<input type='text' size='8' name='warehouse_code' value='<%=warehouse_code%>' readOnly> <input type='text' size='15' name='warehouse_name' value='<%=warehouse_name%>' readOnly> <a href="javascript:sel_warehouse();"><img src="../st/images/bt_search.gif" border="0" align="absmiddle" readOnly></a>--></td></tr>
	    <tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
	   </tbody></table>
...
{ 
	...
	if(f.quantity.value == '0'){
		alert("입고수량을 입력하십시오.(입고수량은 0이상어야 합니다)");
		f.quantity.focus();
		return;
	}
