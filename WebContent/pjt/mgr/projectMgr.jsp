...
<%
	...
	*********************************************************************/
	...
	query = "where (keyname='PJT_PML') and (a.div_code = b.ac_code) order by div_code ASC";
	bean.setSearchWrite(query);
	bean.init_write();
...
function write()
{
	...
	document.sForm.action='projectMgr.jsp';
...
{
	document.vForm.action='projectMgr.jsp';
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0 valign="top">
	...
	<TR height=27><!-- 타이틀 및 페이지 정보 -->
		...
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			...
			<TR bgcolor="#BAC2CD">
				<TD valign='middle' class="title"><img src="../images/blet.gif" align="absmiddle"> 과제PM 관리</TD>
			</TR>
			</TBODY>
		</TABLE>
		</TD>
