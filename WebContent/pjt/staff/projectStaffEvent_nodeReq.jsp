...
function nodeAppReq()
{
	...
	if(con.length < 10) { alert('진행내용요약은 10자이상입니다.\n\n입력후 다시 상신하십시요.'); return; }
	...
	<TR>
		<TD height=27><!--타이틀-->
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../pjt/images/blet.gif"> 노드완료 승인요청 작성</TD>
				</TR>
				</TBODY>
			</TABLE>
		</TD>
		...
		<TD height=32><!--버튼-->
			<TABLE cellSpacing=0 cellPadding=0>
				...
				<TR>
					...
					<TD align=left width='20%'><a href="javascript:nodeAppReq();">승인요청</a>
	...
	<tr>
		...
		<table cellspacing=0 cellpadding=2 width="100%" border=0>
			...
			<tr>
			   ...
			   <td width="40%" height="25" class="bg_04">승인요청 &nbsp;&nbsp;[<%=anbdt.getDate()%> <%=days%>] <input type='hidden' name='wm_type' value='N' size=10></td>
			</tr>
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="10%" height="25" class="bg_03" background="../pjt/images/bg-01.gif">진행내용<br>요 약</td>
			   <td width="90%" height="25" class="bg_04" colspan=3>
				<textarea name='evt_content' rows='7' cols='80'></textarea></td>
			</tr>
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="10%" height="25" class="bg_03" background="../pjt/images/bg-01.gif">문제점<br>요 약</td>
			   <td width="90%" height="25" class="bg_04" colspan=3>
				<textarea name='evt_note' rows='7' cols='80'></textarea></td>
			</tr>
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="10%" height="25" class="bg_03" background="../pjt/images/bg-01.gif">이슈사항<br>요 약</td>
			   <td width="90%" height="25" class="bg_04" colspan=3>
