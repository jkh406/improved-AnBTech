...
<%
	...
	*********************************************************************/
	String pjt_code = "";
	pjt_code = pjtDAO.getProjectCode (div_code,"A");		//A:전사공통, D:부서공통
...
function sendSave()
{
	...
	if(rtn.length == 0) { alert('과제코드를 지정하십시요.');  return; }
	...
	document.eForm.mode.value='PJC_WA';	
	...
	<TR>
		<TD height=27><!--타이틀-->
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../images/blet.gif">과제코드 및 과제명 등록</TD>
				</TR>
				</TBODY>
			</TABLE>
		</TD>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<table cellspacing=0 cellpadding=2 width="100%" border=0>
			...
			<tr>
			   <td width="20%" height="25" class="bg_03" background="../images/bg-01.gif">과제코드</td>
			   <td width="80%" height="25" class="bg_04"><%=pjt_code%>
					<input type='hidden' name='pjt_code' value='<%=pjt_code%>'></td>
			</tr>
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="20%" height="25" class="bg_03" background="../images/bg-01.gif">과제이름</td>
