...
<%
	...
	*********************************************************************/
	...
	com.anbtech.util.normalFormat money = new com.anbtech.util.normalFormat("#,000");	//출력형식 (금액)
	...
	*********************************************************************/
	...
	table_list = genDAO.getAllStandbyProjectList();		//전사 기본정보 미등록 과제
...
function sendSave()
{
	...
	document.eForm.mode.value='PBS_WA';	
