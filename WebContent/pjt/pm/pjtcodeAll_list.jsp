...
function write()
{
	document.sForm.action='../pjt/pm/pjtcodeAll_write.jsp';
	document.sForm.submit();
}
...
{
	document.sForm.action='../servlet/pjtCodeServlet';
	document.sForm.mode.value='PJC_VA';
...
function contentDelete(pid)
{
	...
	document.dForm.mode.value="PJC_DA";
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0 valign="top">
	...
	<TR height=27><!-- 타이틀 및 페이지 정보 -->
		...
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			...
			<TR bgcolor="#BAC2CD">
				<TD valign='middle' class="title"><img src="../pjt/images/blet.gif" align="absmiddle"> 전사공통 과제코드</TD>
