...
function goPage(a) 
{
	...
	document.sForm.mode.value='PBS_LD';
...
function write()
{
	document.sForm.action='../pjt/pm/projectGenDiv_write.jsp';
	document.sForm.submit();
}
...
{
	document.sForm.action='../servlet/projectGenServlet';
	document.sForm.mode.value='PBS_VD';
...
function contentDelete(pjt_code)
{
	...
	document.dForm.mode.value="PBS_DD";
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0 valign="top">
	...
	<TR height=27><!-- 타이틀 및 페이지 정보 -->
		...
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			...
			<TR bgcolor="#BAC2CD">
				<TD valign='middle' class="title"><img src="../pjt/images/blet.gif" align="absmiddle"> 부서공통 과제기본정보</TD>
		...
		<TABLE height=32 cellSpacing=0 cellPadding=0 width="100%" border='0'>
			...
			<TR>
				...
				<TD align=left width='500'>
					...
					<input type="hidden" name="mode" size="15" value="PBS_LD">
