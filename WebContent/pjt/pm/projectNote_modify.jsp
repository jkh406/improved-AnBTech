...
<%
	...
	//	등록된 문제점 내용읽기
	//-----------------------------------
	String note="",solution="",pid="",book_date="",users="";
...
function noteModify()
{
	...
	document.sForm.mode.value='PNT_MW';
	...
	<TR>
		<TD height=27><!--타이틀-->
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../pjt/images/blet.gif"> 해당과제 문제점 수정</TD>
				</TR>
				</TBODY>
			</TABLE>
		</TD>
		...
		<TD height=32><!--버튼-->
			<TABLE cellSpacing=0 cellPadding=0>
				...
				<TR>
					...
					<a href="javascript:noteModify();"><img src="../pjt/images/bt_modify.gif" border="0" align="absmiddle"></a>
					</TD>
				</TR>
				</TBODY>
			</TABLE>
		...
		<table cellspacing=0 cellpadding=2 width="100%" border=0>
			...
			<tr>
			   ...
			   <td width="90%" height="25" class="bg_04" colspan=3>
					<textarea name='note' rows='5' cols='80'><%=note%></textarea></td>
			</tr>
			<tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
			<tr>
