...
function issueContent()
{
	...
	document.sForm.mode.value='PIS_CW';
	...
	<TR>
		<TD height=27><!--타이틀-->
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../pjt/images/blet.gif"> 과제이슈 해결내용 입력</TD>
				</TR>
				</TBODY>
			</TABLE>
		</TD>
		...
		<TD height=32><!--버튼-->
			<TABLE cellSpacing=0 cellPadding=0>
				...
				<TR>
					...
					%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="javascript:issueContent();"><img src="../pjt/images/bt_add.gif" border="0" align="absmiddle"></a>
					</TD>
				</TR>
				</TBODY>
			</TABLE>
