...
<%
	...
	if(notes_iter.hasNext()) {
		...
		pjt_code = notes.getPjtCode();
		node_code = notes.getNodeCode();
		note = notes.getNote();
		solution = notes.getSolution();
		content = notes.getContent();
		book_date = notes.getBookDate();
		in_date = notes.getInDate();
		sol_date = notes.getSolDate();
	}
%>
	...
	<TR>
		<TD height=27><!--타이틀-->
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../pjt/images/blet.gif"> 문제점 해결내용 보기</TD>
				</TR>
				</TBODY>
			</TABLE>
		</TD>
