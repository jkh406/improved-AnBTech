...
function noteWrite()
{
	var note = document.sForm.note.value;
	if(note.length == 0) { alert('문제점을 입력하십시요.'); return; }
	...
	var r = confirm('등록하시겠습니까? 노드명및 담당자를 확인바랍니다.');
	if(r == false) return;

	document.sForm.action='../servlet/projectNoteServlet';
	document.sForm.mode.value='PNT_NW';
	...
	<TR>
		<TD height=27><!--타이틀-->
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../pjt/images/blet.gif"> 해당과제 문제점 작성</TD>
				</TR>
				</TBODY>
			</TABLE>
		</TD>
		...
		<TD height=32><!--버튼-->
			<TABLE cellSpacing=0 cellPadding=0>
				...
				<TR>
					...
					<a href="javascript:noteWrite();"><img src="../pjt/images/bt_add.gif" border="0" align="absmiddle"></a>
					</TD>
				</TR>
				</TBODY>
			</TABLE>
			   ...
			   <td width="40%" height="25" class="bg_04">
				...
				<%
					for(int i=0; i<man_cnt; i++) {
						out.print("<option value='"+member[i][1]+"'>"+member[i][1]+" "+member[i][2]);
						out.println("</option>");
					} 
				%>
				</select></td>
...
<input type='hidden' name='note_status' value='0'>
</form>
