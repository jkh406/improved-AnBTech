...
function goPage(a) 
{
	...
	document.sForm.mode.value='PJS_LD';
...
{
	document.sForm.action='../servlet/projectStatusServlet';
	document.sForm.mode.value='PJS_MVD';
...
function pjtDelete(pjt_code)
{
	...
	c = confirm("정말로 삭제하시겠습니까? \n\n해당과제에 관련된 모든정보[기본정보 ~ 이력정보등]가 완전히 삭제됩니다.");
	if(c == false) return;

	document.dForm.action='../servlet/projectStatusServlet';
	document.dForm.mode.value="PJS_DD";
...
{
	sParam = "strSrc=../servlet/projectStatusServlet&pjt_code="+pjt_code+"&mode=PJS_VD";	showModalDialog("../pjt/modalFrm.jsp?"+sParam,"","dialogWidth:720px;dialogHeight:340px;resizable=0");
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0 valign="top">
	...
	<TR height=27><!-- 타이틀 및 페이지 정보 -->
		...
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			...
			<TR bgcolor="#BAC2CD">
				<TD valign='middle' class="title"><img src="../pjt/images/blet.gif" align="absmiddle"> 부서공통 과제상태변경</TD>
