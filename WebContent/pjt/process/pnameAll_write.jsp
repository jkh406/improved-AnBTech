...
<%
	...
	*********************************************************************/
	String prs_code = "";
	prs_code = pnameDAO.getPrsnameCode (user_id,div_code,"A");		//A:전사공통, D:부서공통
...
function sendSave()
{
	...
	document.eForm.mode.value='PSN_WA';	
	...
	<TR>
		<TD height=27><!--타이틀-->
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../images/blet.gif">전사공통 프로세스명등록</TD>
				</TR>
				</TBODY>
			</TABLE>
		</TD>
