...
<%			
	...
	*********************************************************************/
	...
	query = " where type='"+div_code+"' and ph_code='"+ph_code+"' and step_code='"+step_code+"' order by doc_code DESC";
	bean.setSearchWrite(query);
	bean.init_write();
...
function sendSave()
{
	...
	document.eForm.mode.value='DOC_WD';	
	document.eForm.submit();
}
//개발단계명 선택하여 관리항목코드 신규생성
function selectPhCode()
{
	document.eForm.action="docDiv_write.jsp";
	...
	<TR>
		<TD height=27><!--타이틀-->
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../images/blet.gif">부서공통 산출물등록</TD>
				</TR>
				</TBODY>
			</TABLE>
		</TD>
