...
function goPage(a) 
{
	...
	document.sForm.mode.value='PHA_LD';
...
function write()
{
	document.sForm.action='../pjt/process/phaseDiv_write.jsp';
	document.sForm.submit();
}
...
{
	document.sForm.action='../servlet/prsCodeServlet';
	document.sForm.mode.value='PHA_VD';
...
function contentDelete(pid)
{
	...
	document.dForm.mode.value="PHA_DD";
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0 valign="top">
	...
	<TR height=27><!-- 타이틀 및 페이지 정보 -->
		...
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			...
			<TR bgcolor="#BAC2CD">
				<TD valign='middle' class="title"><img src="../pjt/images/blet.gif" align="absmiddle"> 프로세스코드 부서공통 개발단계[Phase]</TD>
		...
		<TABLE height=32 cellSpacing=0 cellPadding=0 width="100%" border='0'>
			...
			<TR>
				...
				<TD align=left width='400'>
					...
					<%
						String[] sitems = {"ph_name","ph_code"};
						String[] snames = {"단계이름","단계코드"};
						String sel = "";
					...
					<input type="hidden" name="mode" size="15" value="PHA_LA">
	...
	<TR height=100%>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TR vAlign=middle height=25>
				<TD noWrap width=100 align=middle class='list_title'>개발단계순서</TD>
				<TD noWrap width=6 class='list_title'><IMG src="../pjt/images/list_tep.gif"></TD>
				<TD noWrap width=150 align=middle class='list_title'>개발단계코드</TD>
				<TD noWrap width=6 class='list_title'><IMG src="../pjt/images/list_tep.gif"></TD>
