...
<%
	...
	*********************************************************************/
	String prs_code = "";
	prs_code = pnameDAO.getPrsnameCode (user_id,div_code,"D");		//A:전사공통, D:부서공통
	...
	<TR>
		<TD height=27><!--타이틀-->
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../images/blet.gif">부서공통 프로세스명등록</TD>
				</TR>
				</TBODY>
			</TABLE>
		</TD>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<table cellspacing=0 cellpadding=2 width="100%" border=0>
			...
			<tr>
			   <td width="20%" height="25" class="bg_03" background="../images/bg-01.gif">프로세스 코드</td>
			   <td width="80%" height="25" class="bg_04"><%=prs_code%>
					<input type='hidden' name='prs_code' value='<%=prs_code%>'></td>
			</tr>
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="20%" height="25" class="bg_03" background="../images/bg-01.gif">프로세스 이름</td>
			   <td width="80%" height="25" class="bg_04">
					<input type='text' size=30 name='prs_name' value=''></td>
			</tr>
			<tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
...
<input type='hidden' name='type' value='<%=div_code%>'>			<% //P:전사 , 부서코드:부서 %>
</form>
