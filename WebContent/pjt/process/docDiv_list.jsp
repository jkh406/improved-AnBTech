...
<%
	...
	if(search_item == null) search_item = "doc_name";
...
function goPage(a) 
{
	...
	document.sForm.mode.value='DOC_LD';
...
function write()
{
	document.sForm.action='../pjt/process/docDiv_write.jsp';
	document.sForm.submit();
}
...
{
	document.sForm.action='../servlet/prsCodeServlet';
	document.sForm.mode.value='DOC_VD';
...
function contentDelete(pid)
{
	...
	document.dForm.mode.value="DOC_DD";
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0 valign="top">
	...
	<TR height=27><!-- 타이틀 및 페이지 정보 -->
		...
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			...
			<TR bgcolor="#BAC2CD">
				<TD valign='middle' class="title"><img src="../pjt/images/blet.gif" align="absmiddle"> 프로세스코드 부서공통 관리항목 산출물</TD>
		...
		<TABLE height=32 cellSpacing=0 cellPadding=0 width="100%" border='0'>
			...
			<TR>
				...
				<TD align=left width='400'>
					...
					<%
						String[] sitems = {"doc_name","doc_code"};
						String[] snames = {"산출물이름","산출물코드"};
						String sel = "";
					...
					<input type="hidden" name="mode" size="15" value="DOC_LD">
	...
	<TR height=100%>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TR vAlign=middle height=25>
				...
				<TD noWrap width=6 class='list_title'><IMG src="../pjt/images/list_tep.gif"></TD>
				<TD noWrap width=100 align=middle class='list_title'>산출물 코드</TD>
				<TD noWrap width=6 class='list_title'><IMG src="../pjt/images/list_tep.gif"></TD>
				<TD noWrap width=250 align=middle class='list_title'>산출물 이름</TD>
				<TD noWrap width=6 class='list_title'><IMG src="../pjt/images/list_tep.gif"></TD>
		...
		%>
			...
			<TR onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
				...
				<TD><IMG height=1 width=1></TD>
				<TD align=left height="24" class='list_bg'>&nbsp;&nbsp;<%=table.getDocCode()%></TD>
				<TD><IMG height=1 width=1></TD>
				<TD align=left height="24" class='list_bg'>&nbsp;&nbsp;<%=table.getDocName()%></TD>
				<TD><IMG height=1 width=1></TD>
