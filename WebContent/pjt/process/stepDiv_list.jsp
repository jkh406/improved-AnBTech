...
<%
	...
	if(search_item == null) search_item = "ph_name";
...
function goPage(a) 
{
	...
	document.sForm.mode.value='STP_LD';
...
function write()
{
	document.sForm.action='../pjt/process/stepDiv_write.jsp';
	document.sForm.submit();
}
...
{
	document.sForm.action='../servlet/prsCodeServlet';
	document.sForm.mode.value='STP_VD';
...
function contentDelete(pid)
{
	...
	document.dForm.mode.value="STP_DD";
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0 valign="top">
	...
	<TR height=27><!-- 타이틀 및 페이지 정보 -->
		...
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			...
			<TR bgcolor="#BAC2CD">
				<TD valign='middle' class="title"><img src="../pjt/images/blet.gif" align="absmiddle"> 프로세스코드 부서공통 관리항목[step]</TD>
		...
		<TABLE height=32 cellSpacing=0 cellPadding=0 width="100%" border='0'>
			...
			<TR>
				...
				<TD align=left width='400'>
					...
					<%
						String[] sitems = {"step_name","step_code"};
						String[] snames = {"관리항목이름","관리항목코드"};
						String sel = "";
					...
					<input type="hidden" name="mode" size="15" value="STP_LA">
	...
	<TR height=100%>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TR vAlign=middle height=25>
				<TD noWrap width=100 align=middle class='list_title'>개발단계코드</TD>
				...
				<TD noWrap width=6 class='list_title'><IMG src="../pjt/images/list_tep.gif"></TD>
				<TD noWrap width=100 align=middle class='list_title'>관리항목코드</TD>
				<TD noWrap width=6 class='list_title'><IMG src="../pjt/images/list_tep.gif"></TD>
		...
		%>
			...
			<TR onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
				<TD align=middle height="24" class='list_bg'><%=table.getPhCode()%></TD>
				<TD><IMG height=1 width=1></TD>
				<TD align=middle height="24" class='list_bg'><%=table.getPhName()%></TD>
				<TD><IMG height=1 width=1></TD>
				<TD align=middle height="24" class='list_bg'><%=table.getStepCode()%></TD>
				<TD><IMG height=1 width=1></TD>
				<TD align=middle height="24" class='list_bg'><%=table.getStepName()%></TD>
				<TD><IMG height=1 width=1></TD>
