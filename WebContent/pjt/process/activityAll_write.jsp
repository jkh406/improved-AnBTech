...
<%			
	...
	*********************************************************************/
	...
	query = "where type='P' and ph_code='"+ph_code+"' and step_code='"+step_code+"' order by act_code DESC";
	bean.setSearchWrite(query);
	bean.init_write();
...
function sendSave()
{
	...
	document.eForm.mode.value='ACT_WA';	
	document.eForm.submit();
}
//개발단계명 선택하여 관리항목코드 신규생성
function selectPhCode()
{
	document.eForm.action="activityAll_write.jsp";
	...
	<TR>
		<TD height=27><!--타이틀-->
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../images/blet.gif">전사공통 실행항목[Activity]등록</TD>
				</TR>
				</TBODY>
			</TABLE>
		</TD>
