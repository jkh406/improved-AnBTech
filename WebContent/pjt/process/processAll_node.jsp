...
if(RD == "Reload") {
	...
	parent.viewL.document.sForm.action='processAll_tree.jsp';
...
function writePrs()
{
	...
	document.sForm.mode.value='STD_WA';
...
function deletePrs()
{
	...
	document.sForm.action='../servlet/prsStandardServlet';
	document.sForm.mode.value='STD_DA';
	document.sForm.node_code.value=node_code;
	document.sForm.submit();
}
...
function writeDoc()
{
	...
	document.dForm.mode.value='SDC_WA';
...
function deleteDoc()
{
	...
	document.dForm.action='../servlet/prsStandardServlet';
	document.dForm.mode.value='SDC_DA';
	document.dForm.node_code.value=node_code;
	document.dForm.submit();
}
//프로세스 일괄 선택하기
