...
<%
	...
	*********************************************************************/
	String ph_code = "";
	ph_code = phaseDAO.getPhaseCode (user_id,div_code,"D");		//A:전사공통, D:부서공통
...
function sendSave()
{
	...
	document.eForm.mode.value='PHA_WD';	
	...
	<TR>
		<TD height=27><!--타이틀-->
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../images/blet.gif">부서공통 개발단계[Phase]등록</TD>
				</TR>
				</TBODY>
			</TABLE>
		</TD>
