...
function sendModify()
{
	...
	if(rtn.length == 0) { alert('관리항목코드를 지정하십시요.');  return; }
	...
	document.eForm.mode.value='STP_MA';	
	...
	<TR>
		<TD height=27><!--타이틀-->
			<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
				...
				<TR bgcolor="#BAC2CD">
					<TD valign='middle' class="title"><img src="../pjt/images/blet.gif">전사공통 관리항목[Step]수정</TD>
				</TR>
				</TBODY>
			</TABLE>
		</TD>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<table cellspacing=0 cellpadding=2 width="100%" border=0>
			...
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="20%" height="25" class="bg_03" background="../pjt/images/bg-01.gif">관리항목코드</td>
			   <td width="80%" height="25" class="bg_04"><%=step_code%>
					<input type='hidden' name='step_code' value='<%=step_code%>'></td>
			</tr>
			<tr bgcolor="c7c7c7"><td height=1 colspan="4"></td></tr>
			<tr>
			   <td width="20%" height="25" class="bg_03" background="../pjt/images/bg-01.gif">관리항목이름</td>
			   <td width="80%" height="25" class="bg_04">
					<input type='text' name='step_name' value='<%=step_name%>'></td>
			</tr>
			<tr bgcolor="C7C7C7"><td height="1" colspan="4"></td></tr>
