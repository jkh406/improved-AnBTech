...
function goPage(a) 
{
	...
	document.sForm.mode.value='STP_LA';
...
function write()
{
	document.sForm.action='../pjt/process/stepAll_write.jsp';
	document.sForm.submit();
}
...
{
	document.sForm.action='../servlet/prsCodeServlet';
	document.sForm.mode.value='STP_VA';
...
function contentDelete(pid)
{
	...
	document.dForm.mode.value="STP_DA";
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0 valign="top">
	...
	<TR height=27><!-- 타이틀 및 페이지 정보 -->
		...
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			...
			<TR bgcolor="#BAC2CD">
				<TD valign='middle' class="title"><img src="../pjt/images/blet.gif" align="absmiddle"> 프로세스코드 전사공통 관리항목[step]</TD>
