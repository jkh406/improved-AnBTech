...
<%
	...
	if(search_item == null) search_item = "prs_name";
...
function goPage(a) 
{
	...
	document.sForm.mode.value='PSN_LD';
...
function write()
{
	document.sForm.action='../pjt/process/pnameDiv_write.jsp';
	document.sForm.submit();
}
...
{
	document.sForm.action='../servlet/prsStandardServlet';
	document.sForm.mode.value='PSN_VD';
...
function contentDelete(pid)
{
	...
	document.dForm.mode.value="PSN_DD";
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0 valign="top">
	...
	<TR height=27><!-- 타이틀 및 페이지 정보 -->
		...
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
			...
			<TR bgcolor="#BAC2CD">
				<TD valign='middle' class="title"><img src="../pjt/images/blet.gif" align="absmiddle"> 부서공통 프로세스명</TD>
		...
		<TABLE height=32 cellSpacing=0 cellPadding=0 width="100%" border='0'>
			...
			<TR>
				...
				<TD align=left width='400'>
					...
					<%
						String[] sitems = {"prs_name","prs_code"};
						String[] snames = {"프로세스이름","프로세스코드"};
						String sel = "";
					...
					<input type="hidden" name="mode" size="15" value="PSN_LA">
	...
	<TR height=100%>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			...
			<TR vAlign=middle height=25>
				<TD noWrap width=10 align=middle class='list_title'>#</TD>
				<TD noWrap width=6 class='list_title'><IMG src="../pjt/images/list_tep.gif"></TD>
				<TD noWrap width=150 align=middle class='list_title'>프로세스코드</TD>
				<TD noWrap width=6 class='list_title'><IMG src="../pjt/images/list_tep.gif"></TD>
				<TD noWrap width=250 align=middle class='list_title'>프로세스이름</TD>
				<TD noWrap width=6 class='list_title'><IMG src="../pjt/images/list_tep.gif"></TD>
		...
		%>
			...
			<TR onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
				...
				<TD align=middle height="24" class='list_bg'><%=table.getPrsCode()%></TD>
				<TD><IMG height=1 width=1></TD>
				<TD align=left height="24" class='list_bg'>&nbsp;&nbsp;<%=table.getPrsName()%></TD>
				<TD><IMG height=1 width=1></TD>
				<TD align=left height="24" class='list_bg'><%=table.getModify()%>&nbsp;&nbsp;<%=table.getDelete()%></TD>
			</TR>
