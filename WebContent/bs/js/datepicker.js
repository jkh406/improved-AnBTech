...
DatePicker.prototype.create = function ( doc ) {
	...
	this._todayButton.appendChild( doc.createTextNode( "금일" ) );
...
function ShowDP(obj, format_str) {
	...
	//x = getClientLeft(obj);
	//y = getClientTop(obj);
	x = document.body.scrollLeft + event.clientX;											// 스크롤 영역 보정
	y = document.body.scrollTop + event.clientY;

	objdiv.style.pixelTop	= y-181;
	objdiv.style.pixelLeft	= x+60;
...
function Calendar(obj, format_str) {
...
document.write("<div id=dpdiv style=\"background:buttonface;display:none;position: absolute;\"></div>");