    ...
    <TD vAlign=top>
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../bs/images/blet.gif" align="absmiddle"> 품목별할증관리</TD>
			...
			<TR>
			  ...
			  <TD align=left width='500'>
				  <form method=get action='SalesConfigMgrServlet' name='srForm' onSubmit="if(this.searchword.value.length< 2){alert('검색어는 2자이상 입력하셔야 합니다.');this.searchword.value='';this.searchword.focus();return false;}else{return true;}" style="margin:0">
					  ...
					  <a href="SalesConfigMgrServlet?mode=write_item_premium"><img src="../bs/images/bt_reg.gif" border="0" align="absmiddle"></a>
...
%>
			...
			<TR><TD colSpan=17 background="../bs/images/dot_line.gif"></TD></TR>
<%
	}				
%>
