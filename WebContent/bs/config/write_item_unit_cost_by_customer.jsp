...
<%
	...
	table = (ItemUnitCostTable)request.getAttribute("COST_CUSTOMER");

	String mode					= request.getParameter("mode");
	String title				= "고객별 품목 단가등록";
	if(mode.equals("modify_item_unit_cost_by_customer")) title = "고객별 품목 단가수정";	
	...
	String customer_code		= table.getCustomerCode();     
	String customer_name		= table.getCustomerName();     


	String readonly				= "";
	if(mode.equals("modify_item_unit_cost_by_customer")) readonly = "readonly";	
%>
...
<TABLE  cellspacing=0 cellpadding=0 width="100%" border=0>
	<TBODY>
		...
		<TR><TD width="15%" height="25" class="bg_03" background="../bs/images/bg-01.gif">거래처코드</TD>
            <TD width="35%" height="25" class="bg_04">
				<INPUT type='text' size='10' maxlength='20' name='customer_code' value='<%=customer_code%>' <%=readonly%> class="text_01" maxlength="2">
				<%if(!mode.equals("modify_item_unit_cost_by_customer")){%>
				<a href="javascript:sel_supplyer();"><img src="../bs/images/bt_search.gif" border="0" align="absmiddle"></a>
				<%}%>
			</TD>
            <TD width="15%" height="25" class="bg_03" background="../bs/images/bg-01.gif">거래처명</TD>
            <TD width="35%" height="25" class="bg_04">
				<INPUT type='text' size='20' maxlength='50' name='customer_name' value='<%=customer_name%>' class="text_01">
			</TD></TR>
	   	<TR bgcolor="c7c7c7"><TD height=1 colspan="4"></TD></TR>
		<TR><TD width="15%" height="25" class="bg_03" background="../bs/images/bg-01.gif">품목코드</TD>
            <TD width="35%" height="25" class="bg_04">
				<INPUT type='text' size='10' maxlength='12' name='item_code' value='<%=item_code%>' <%=readonly%> class="text_01" maxlength="2">
...
function checkForm(){
	...
	if(f.customer_code.value=="" || f.customer_name.value==""){
		alert("거래처를 입력하십시요.");
...
function del(){
	...
	location.href="../servlet/SalesConfigMgrServlet?mode=delete_item_unit_cost_by_customer&mid=<%=mid%>";
	else return;
}
...
{ 
	url = "../bs/config/searchCompany.jsp?sf=eForm&sid=customer_code&sname=customer_name";
