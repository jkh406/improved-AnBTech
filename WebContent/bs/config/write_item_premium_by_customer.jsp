...
<%
	...
	table = (ItemPremiumTable)request.getAttribute("PREMIUM_CUSTOMER");

	String mode					= request.getParameter("mode");
	String title				= "고객별 품목할증정보 등록";
	if(mode.equals("modify_item_premium_by_customer")) title = "고객별 품목할증정보 수정";	
	...
	String readonly				= "";
	if(mode.equals("modify_item_premium_by_customer")) readonly = "readonly";	
%>
	...
	<TBODY>
		...
		<TR><TD width="15%" height="25" class="bg_03" background="../bs/images/bg-01.gif">거래처코드</TD>
            <TD width="35%" height="25" class="bg_04">
				<INPUT type='text' size='10' maxlength='12' name='customer_code' value='<%=customer_code%>' <%=readonly%> class="text_01" maxlength="2">
            ...
            <TD width="35%" height="25" class="bg_04">
				<INPUT type='text' size='20' name='customer_name' value='<%=customer_name%>' class="text_01">
			</TD></TR>
		<TR bgcolor="c7c7c7"><TD height=1 colspan="4"></TD></TR>
...
function del(){
	...
	location.href="../servlet/SalesConfigMgrServlet?mode=delete_item_premium_by_customer&mid=<%=mid%>";
	else return;
}
