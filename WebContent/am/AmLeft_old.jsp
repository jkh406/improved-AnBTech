...
<%	// 자산담당자 권한 체크
	int idx2 = prg_priv.indexOf("AM02");
	if (idx2 >= 0){
%>
  <TR><!--자산대여업무 -->
...
<%	// 자산관리자 권한 체크
	int idx3 = prg_priv.indexOf("AM02");
	if (idx3 >= 0){
%>
  <TR><!--관리자 설정 -->
      ...
      border=0>
		...
		<TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
            ...
            href="../servlet/AssetServlet?mode=asset_del_list" target=up><SPAN id=m4_3>폐기자산관리</SPAN></A> </TD></TR>
		...
		<TR bgColor=#f3f3f3 height=22>
          <TD class=type1 vAlign=center align=left><IMG 
            ...
            href="admin/settingPrivilege.jsp" target=up><SPAN id=m4_4>관리자설정</SPAN></A> </TD></TR></TBODY></TABLE></SPAN></TD></TR>
<%	}else{	%>
