...
<%
	...
	//out.println("target_pg:"+target_pg+"   target_id:"+target_id);
%>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
				  ...
				  <tr><td width="100%" height="30" bgcolor="#EAF3FD"  align="center">
					<form name='sForm' method=post action="javascript:go_search();" onSubmit="go_search();" style="margin:0">
						...
						</select> <input type='text' name='sWord' size='10'> <input type = 'button' value ='검색' onClick = 'javascript:go_search();'>
					</form></td></tr>
				</table>		   
		   </td></tr>
...
function go_sel(item)
{
	...
	if(my_ret == true){
		...
		eval("opener.document." + target_pg).value = id + "/" + name;
			if(target_id=="crr_id")
			opener.document.crr_id.value = id;
