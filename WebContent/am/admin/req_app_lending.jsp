    ...
    <TD vAlign=top>
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../am/images/blet.gif" align="absmiddle"> 자산대여업무(결재건)</TD>
		...
		<TABLE height=32 cellSpacing=0 cellPadding=0 width="100%" border='0'>
			...
			<TR>
			  ...
			  <TD align=left width='500'>
					<IMG src="../am/images/bt_app_loan.gif" onclick="req_app_list('lending_list')" align='absmiddle' style="cursor:hand">
	  ...
	  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
			<TR vAlign=middle height=23>
			  ...
			  <TD noWrap width=6 class='list_title'><IMG src="../am/images/list_tep2.gif"></TD>
			  <TD noWrap width=100% align=middle class='list_title'>적용기간</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../am/images/list_tep2.gif"></TD>
...
//			String as_status_Info = asHistoryTable.getAsStatusInfo();
//			String flag = asHistoryTable.getFlag();
//			String flag2 = asHistoryTable.getFlag2();
%>
