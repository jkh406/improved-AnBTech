    ...
    <TD vAlign=top>
		<TABLE height=27 cellSpacing=0 cellPadding=0 width="100%">
		  <TBODY>
			...
			<TR bgcolor="#BAC2CD">
			  <TD valign='middle' class="title"><img src="../am/images/blet.gif" align="absmiddle"> 자산대여업무</TD>
		...
		<TABLE height=32 cellSpacing=0 cellPadding=0 width="100%" border='0'>
			...
			<TR>
			  ...
			  <TD align=left width='500'>
					<IMG src="../am/images/bt_app_loan.gif" onclick="req_app_lending('lending_list')" align='absmiddle' style="cursor:hand">
					<IMG src="../am/images/bt_target_loan.gif" onclick="javascript:go_TransOutList('TransOutList')" align='absmiddle' style="cursor:hand">
					<IMG src="../am/images/bt_target_return.gif"   onclick="javascript:go_EnteringList('EnteringList')"  align='absmiddle' style="cursor:hand">
	  ...
	  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
			<TR vAlign=middle height=23>
			  ...
			  <TD noWrap width=100% align=middle class='list_title'>대여기간</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../am/images/list_tep2.gif"></TD>
			  <TD noWrap width=120 align=middle class='list_title'>대여자</TD>
			  <TD noWrap width=6 class='list_title'><IMG src="../am/images/list_tep2.gif"></TD>
...
%>
			<TR onmouseover="this.style.backgroundColor='#F5F5F5'" onmouseout="this.style.backgroundColor=''" bgColor=#ffffff>
			  ...
			  <TD align=middle class='list_bg'><%=link%></td>
			   <TD><IMG height=1 width=1></TD>
			  <TD align=middle class='list_bg'><a href="javascript:go_print('<%=h_no%>','<%=as_no%>','<%=pid%>')"><font color=#3366FF><IMG src='../am/images/lt_view_app.gif' align='absmiddle' border='0'></font></a></td>
			</TR>
...
<script language="javascript">
	...
	// 대여 결재 요청 List로 분기
	function req_app_lending(mode){  
	   location.href ="../servlet/AssetServlet?mode="+mode+"&div=lending";
	}
	...
	function go_as_process(u_date,u_id,h_no,as_no,o_status,as_status,mode_in){
		...
		// 현재 상태 처리시 메시지 string	
		if(o_status=="l" && as_status=="16") { str ="반납"; 
		} else if(o_status=="o" && as_status=="7") { str ="반납"; 
		} else if(o_status=="l" && as_status=="5" && mode_in=="lending_process") { str = "대여"; 
		} else if(o_status=="l" && as_status=="5" && mode_in=="cancel_lending")	 { str = "대여 취소";
		} else if(o_status=="o" && as_status=="5" && mode_in=="cancel_out")		 { str = "반출 취소";
		} else if(o_status=="o" && as_status=="5" && mode_in=="out_process")	 { str = "반출";
		}

		if(confirm(str+" 처리 하시겠습니까?")) {
	...
	{
		var sParam = "../servlet/AssetServlet?mode=AppViewPrint&h_no="+h_no+"&as_no="+asno+"&pid="+pid+"&frmWidth=720&frmHeight=600";
		wopen(sParam,"","710","600","toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=0,resizable=0");
		//var rval = showModalDialog("../am/as_user/modalFrm_print.jsp?"+sParam,"","dialogWidth:720px;dialogHeight:600px;toolbar=0;location=0;directories=0;status=0;menuBar=0;scrollBars=0;resizable=0");
	}
