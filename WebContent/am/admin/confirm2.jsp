...
<script language='javascript'>
	...
	if(req_confirm == true){
		location.href = "../gw/approval/module/Asset_ReApp.jsp?mode=app_asset_view&h_no=<%=h_no%>&as_no=<%=as_no%>&o_status=<%=o_status%>&as_status=<%=as_status%>";		
	}else{
		location.href = "../servlet/AssetServlet?mode=lending_list";				
	}
</script>
</BODY>
</html>