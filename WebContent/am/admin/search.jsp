...
<%
	...
	if(category_full.equals("")||category_full.equals("&nbsp;")||category_full.equals("?")) {category_full="전체 카테고리";}
...
<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<!--타이틀-->
		...
		<TABLE cellspacing=0 cellpadding=2 width="98%" border=0>
			...
			<TR>
				<TD width="17%" height="25" class="bg_01" background="../images/bg-01.gif">자산분류</TD>
			...
			<TR>
				...
				<TD width="83%" height="25" class="bg_02"><input type="text" name="s_day" size="8"> ~ <input type="text" name="e_day" size="8" > (예:20031225 ~ 20021225)</TD></TR>
			<TR bgcolor="C7C7C7"><TD height="1" colspan="2"></TD></TR>
			<TR>
				<TD width="17%" height="25" class="bg_01" background="../images/bg-01.gif">자산가치</TD>
				<TD width="83%" height="25" class="bg_02"><input type="text" name="as_value1" size="10">원 ~ <input type="text" name="as_value2" size="10">원 (예:100000원~1000000원)</TD></TR>
			<TR bgcolor="C7C7C7"><TD height="1" colspan="2"></TD></TR>
			<TR>
				<TD width="17%" height="25" class="bg_01" background="../images/bg-01.gif">사용자명</TD>
				<TD width="83%" height="25" class="bg_02"><input type="text" name="crr_name" size="10"></TD></TR>
			<TR bgcolor="C7C7C7"><TD height="1" colspan="2"></TD></TR>
			<TR>
				<TD width="17%" height="25" class="bg_01" background="../images/bg-01.gif">부서명</TD>
